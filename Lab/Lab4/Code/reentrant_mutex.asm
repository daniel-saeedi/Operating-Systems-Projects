...
int main(int argc, char *argv[])
{
  ...
  1c:	e8 0f 02 00 00       	call   230 <atoi>
  ...
  25:	89 c3                	mov    %eax,%ebx
    printf(1, "acquire() count: %d\n", count);
  27:	68 88 07 00 00       	push   $0x788
  2c:	6a 01                	push   $0x1
  2e:	e8 ed 03 00 00       	call   420 <printf>
    reentrant_mutex(count);
  33:	89 1c 24             	mov    %ebx,(%esp)
  36:	e8 08 03 00 00       	call   343 <reentrant_mutex>
    exit();
  3b:	e8 63 02 00 00       	call   2a3 <exit>
...
printf(int fd, const char *fmt, ...)
{
 ...
 5a4:	eb 1a                	jmp    5c0 <printf+0x1a0>
          s = "(null)";
 5a6:	bb 9d 07 00 00       	mov    $0x79d,%ebx
        while(*s != 0){
