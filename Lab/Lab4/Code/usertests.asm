...
main(int argc, char *argv[])
{
  ...
  if(open("usertests.ran", 0) >= 0){
      ...
      2a:	e8 74 39 00 00       	call   39a3 <open>
    ...
    printf(1, "already ran user tests -- rebuild fs.img\n");
      36:	52                   	push   %edx
      37:	52                   	push   %edx
      38:	68 84 55 00 00       	push   $0x5584
      3d:	6a 01                	push   $0x1
      3f:	e8 9c 3a 00 00       	call   3ae0 <printf>
    exit();
      44:	e8 1a 39 00 00       	call   3963 <exit>
  }
  close(open("usertests.ran", O_CREATE));
      ...
      55:	e8 49 39 00 00       	call   39a3 <open>
      5a:	89 04 24             	mov    %eax,(%esp)
      5d:	e8 29 39 00 00       	call   398b <close>

  argptest();
      62:	e8 09 36 00 00       	call   3670 <argptest>
  createdelete();
  ...
  bigargtest();
      80:	e8 8b 32 00 00       	call   3310 <bigargtest>
  bigwrite();
      85:	e8 06 24 00 00       	call   2490 <bigwrite>
  bigargtest();
      8a:	e8 81 32 00 00       	call   3310 <bigargtest>
  bsstest();
      8f:	e8 0c 32 00 00       	call   32a0 <bsstest>
  sbrktest();
      94:	e8 37 2d 00 00       	call   2dd0 <sbrktest>
  validatetest();
      99:	e8 42 31 00 00       	call   31e0 <validatetest>
  ...
  uio();
     107:	e8 e4 34 00 00       	call   35f0 <uio>

  exectest();
     10c:	e8 ff 08 00 00       	call   a10 <exectest>

  exit();
     111:	e8 4d 38 00 00       	call   3963 <exit>
...
00000120 <iputtest>:
{
  ...
  if(chdir("iputdir") < 0){
     ...
     155:	e8 79 38 00 00       	call   39d3 <chdir>
  ...
  if(unlink("../iputdir") < 0){
     ...
     16d:	e8 41 38 00 00       	call   39b3 <unlink>
  ...
  if(chdir("/") < 0){
     ...
     181:	e8 4d 38 00 00       	call   39d3 <chdir>
  ...
  printf(stdout, "iput test ok\n");
     ...
     195:	ff 35 b0 5e 00 00    	pushl  0x5eb0
    ...
    printf(stdout, "mkdir failed\n");
     ...
     1ac:	ff 35 b0 5e 00 00    	pushl  0x5eb0
     1b2:	e8 29 39 00 00       	call   3ae0 <printf>
    exit();
     1b7:	e8 a7 37 00 00       	call   3963 <exit>
    printf(stdout, "chdir / failed\n");
     1bc:	50                   	push   %eax
     1bd:	50                   	push   %eax
     1be:	68 93 3e 00 00       	push   $0x3e93
     1c3:	ff 35 b0 5e 00 00    	pushl  0x5eb0
     1c9:	e8 12 39 00 00       	call   3ae0 <printf>
    exit();
     1ce:	e8 90 37 00 00       	call   3963 <exit>
    printf(stdout, "unlink ../iputdir failed\n");
     1d3:	52                   	push   %edx
     1d4:	52                   	push   %edx
     1d5:	68 77 3e 00 00       	push   $0x3e77
     1da:	ff 35 b0 5e 00 00    	pushl  0x5eb0
     1e0:	e8 fb 38 00 00       	call   3ae0 <printf>
    exit();
     1e5:	e8 79 37 00 00       	call   3963 <exit>
    printf(stdout, "chdir iputdir failed\n");
     1ea:	51                   	push   %ecx
     1eb:	51                   	push   %ecx
     1ec:	68 56 3e 00 00       	push   $0x3e56
     1f1:	ff 35 b0 5e 00 00    	pushl  0x5eb0
     1f7:	e8 e4 38 00 00       	call   3ae0 <printf>
    exit();
     1fc:	e8 62 37 00 00       	call   3963 <exit>
...
00000210 <exitiputtest>:
{
  ...
  printf(stdout, "exitiput test\n");
     ...
     21f:	ff 35 b0 5e 00 00    	pushl  0x5eb0
     225:	e8 b6 38 00 00       	call   3ae0 <printf>
  pid = fork();
     22a:	e8 2c 37 00 00       	call   395b <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     ...
     244:	e8 82 37 00 00       	call   39cb <mkdir>
    ...
    if(chdir("iputdir") < 0){
     ...
     25c:	e8 72 37 00 00       	call   39d3 <chdir>
    ...
    if(unlink("../iputdir") < 0){
     ...
     274:	e8 3a 37 00 00       	call   39b3 <unlink>
     279:	83 c4 10             	add    $0x10,%esp
     27c:	85 c0                	test   %eax,%eax
     27e:	78 28                	js     2a8 <exitiputtest+0x98>
    exit();
     280:	e8 de 36 00 00       	call   3963 <exit>
     285:	8d 76 00             	lea    0x0(%esi),%esi
  wait();
     288:	e8 de 36 00 00       	call   396b <wait>
  printf(stdout, "exitiput test ok\n");
     28d:	83 ec 08             	sub    $0x8,%esp
     290:	68 c6 3e 00 00       	push   $0x3ec6
     295:	ff 35 b0 5e 00 00    	pushl  0x5eb0
     ...
     2b0:	ff 35 b0 5e 00 00    	pushl  0x5eb0
     2b6:	e8 25 38 00 00       	call   3ae0 <printf>
      exit();
     2bb:	e8 a3 36 00 00       	call   3963 <exit>
    printf(stdout, "fork failed\n");
     2c0:	51                   	push   %ecx
     2c1:	51                   	push   %ecx
     2c2:	68 89 4d 00 00       	push   $0x4d89
     2c7:	ff 35 b0 5e 00 00    	pushl  0x5eb0
     2cd:	e8 0e 38 00 00       	call   3ae0 <printf>
    exit();
     2d2:	e8 8c 36 00 00       	call   3963 <exit>
      printf(stdout, "mkdir failed\n");
     2d7:	52                   	push   %edx
     2d8:	52                   	push   %edx
     2d9:	68 48 3e 00 00       	push   $0x3e48
     2de:	ff 35 b0 5e 00 00    	pushl  0x5eb0
     2e4:	e8 f7 37 00 00       	call   3ae0 <printf>
      exit();
     2e9:	e8 75 36 00 00       	call   3963 <exit>
      printf(stdout, "child chdir failed\n");
     2ee:	50                   	push   %eax
     2ef:	50                   	push   %eax
     2f0:	68 b2 3e 00 00       	push   $0x3eb2
     2f5:	ff 35 b0 5e 00 00    	pushl  0x5eb0
     2fb:	e8 e0 37 00 00       	call   3ae0 <printf>
      exit();
     300:	e8 5e 36 00 00       	call   3963 <exit>
...
00000310 <openiputtest>:
{
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     356:	e8 48 36 00 00       	call   39a3 <open>
    if(fd >= 0){
  ...
  printf(stdout, "openiput test ok\n");
    ...
    exit();
     3c0:	e8 9e 35 00 00       	call   3963 <exit>
    printf(stdout, "fork failed\n");
     3c5:	52                   	push   %edx
     3c6:	52                   	push   %edx
     3c7:	68 89 4d 00 00       	push   $0x4d89
     3cc:	ff 35 b0 5e 00 00    	pushl  0x5eb0
     3d2:	e8 09 37 00 00       	call   3ae0 <printf>
    exit();
     3d7:	e8 87 35 00 00       	call   3963 <exit>
    printf(stdout, "mkdir oidir failed\n");
     3dc:	51                   	push   %ecx
     3dd:	51                   	push   %ecx
     3de:	68 ed 3e 00 00       	push   $0x3eed
     3e3:	ff 35 b0 5e 00 00    	pushl  0x5eb0
     3e9:	e8 f2 36 00 00       	call   3ae0 <printf>
    exit();
     3ee:	e8 70 35 00 00       	call   3963 <exit>
    printf(stdout, "unlink failed\n");
     3f3:	50                   	push   %eax
     3f4:	50                   	push   %eax
     3f5:	68 01 3f 00 00       	push   $0x3f01
     3fa:	ff 35 b0 5e 00 00    	pushl  0x5eb0
     400:	e8 db 36 00 00       	call   3ae0 <printf>
    exit();
     405:	e8 59 35 00 00       	call   3963 <exit>
...
00000410 <opentest>:
{
  ...
  printf(stdout, "open test\n");
     ...
     41f:	ff 35 b0 5e 00 00    	pushl  0x5eb0
  ...
  fd = open("echo", 0);
     ...
     433:	e8 6b 35 00 00       	call   39a3 <open>
  if(fd < 0){
  ...
  close(fd);
     ...
     442:	50                   	push   %eax
     443:	e8 43 35 00 00       	call   398b <close>
  fd = open("doesnotexist", 0);
     448:	5a                   	pop    %edx
     449:	59                   	pop    %ecx
     44a:	6a 00                	push   $0x0
     44c:	68 45 3f 00 00       	push   $0x3f45
     451:	e8 4d 35 00 00       	call   39a3 <open>
  if(fd >= 0){
  ...
  printf(stdout, "open test ok\n");
     ...
     465:	ff 35 b0 5e 00 00    	pushl  0x5eb0
    ...
    printf(stdout, "open echo failed!\n");
     ...
     47c:	ff 35 b0 5e 00 00    	pushl  0x5eb0
     482:	e8 59 36 00 00       	call   3ae0 <printf>
    exit();
     487:	e8 d7 34 00 00       	call   3963 <exit>
    printf(stdout, "open doesnotexist succeeded!\n");
     48c:	50                   	push   %eax
     48d:	50                   	push   %eax
     48e:	68 52 3f 00 00       	push   $0x3f52
     493:	ff 35 b0 5e 00 00    	pushl  0x5eb0
     499:	e8 42 36 00 00       	call   3ae0 <printf>
    exit();
     49e:	e8 c0 34 00 00       	call   3963 <exit>
...
000004b0 <writetest>:
{
  ...
  printf(stdout, "small file test\n");
     ...
     4c1:	ff 35 b0 5e 00 00    	pushl  0x5eb0
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     4d8:	e8 c6 34 00 00       	call   39a3 <open>
  if(fd >= 0){
  ...
  for(i = 0; i < 100; i++){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     ...
     4f4:	ff 35 b0 5e 00 00    	pushl  0x5eb0
    ...
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     512:	56                   	push   %esi
     513:	e8 6b 34 00 00       	call   3983 <write>
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     52e:	56                   	push   %esi
     52f:	e8 4f 34 00 00       	call   3983 <write>
  ...
  printf(stdout, "writes ok\n");
     ...
     550:	ff 35 b0 5e 00 00    	pushl  0x5eb0
     556:	e8 85 35 00 00       	call   3ae0 <printf>
  close(fd);
     55b:	89 34 24             	mov    %esi,(%esp)
     55e:	e8 28 34 00 00       	call   398b <close>
  fd = open("small", O_RDONLY);
     563:	5b                   	pop    %ebx
     564:	5e                   	pop    %esi
     565:	6a 00                	push   $0x0
     567:	68 8f 3f 00 00       	push   $0x3f8f
     56c:	e8 32 34 00 00       	call   39a3 <open>
  if(fd >= 0){
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     586:	ff 35 b0 5e 00 00    	pushl  0x5eb0
     58c:	e8 4f 35 00 00       	call   3ae0 <printf>
  i = read(fd, buf, 2000);
     591:	83 c4 0c             	add    $0xc,%esp
     594:	68 d0 07 00 00       	push   $0x7d0
     599:	68 a0 86 00 00       	push   $0x86a0
     59e:	53                   	push   %ebx
     59f:	e8 d7 33 00 00       	call   397b <read>
  if(i == 2000){
    ...
    printf(stdout, "read succeeded ok\n");
     ...
     5ba:	ff 35 b0 5e 00 00    	pushl  0x5eb0
     5c0:	e8 1b 35 00 00       	call   3ae0 <printf>
  close(fd);
     5c5:	89 1c 24             	mov    %ebx,(%esp)
     5c8:	e8 be 33 00 00       	call   398b <close>
  if(unlink("small") < 0){
     5cd:	c7 04 24 8f 3f 00 00 	movl   $0x3f8f,(%esp)
     5d4:	e8 da 33 00 00       	call   39b3 <unlink>
  ...
  printf(stdout, "small file test ok\n");
     ...
     5e8:	ff 35 b0 5e 00 00    	pushl  0x5eb0
     ...
     606:	ff 35 b0 5e 00 00    	pushl  0x5eb0
     ...
     61f:	ff 35 b0 5e 00 00    	pushl  0x5eb0
     625:	e8 b6 34 00 00       	call   3ae0 <printf>
      exit();
     62a:	e8 34 33 00 00       	call   3963 <exit>
    printf(stdout, "error: open small failed!\n");
     62f:	51                   	push   %ecx
     630:	51                   	push   %ecx
     631:	68 06 40 00 00       	push   $0x4006
     636:	ff 35 b0 5e 00 00    	pushl  0x5eb0
     63c:	e8 9f 34 00 00       	call   3ae0 <printf>
    exit();
     641:	e8 1d 33 00 00       	call   3963 <exit>
    printf(stdout, "read failed\n");
     646:	52                   	push   %edx
     647:	52                   	push   %edx
     648:	68 4d 43 00 00       	push   $0x434d
     64d:	ff 35 b0 5e 00 00    	pushl  0x5eb0
     653:	e8 88 34 00 00       	call   3ae0 <printf>
    exit();
     658:	e8 06 33 00 00       	call   3963 <exit>
    printf(stdout, "unlink small failed\n");
     65d:	50                   	push   %eax
     65e:	50                   	push   %eax
     65f:	68 34 40 00 00       	push   $0x4034
     664:	ff 35 b0 5e 00 00    	pushl  0x5eb0
     66a:	e8 71 34 00 00       	call   3ae0 <printf>
    exit();
     66f:	e8 ef 32 00 00       	call   3963 <exit>
    printf(stdout, "error: creat small failed!\n");
     674:	50                   	push   %eax
     675:	50                   	push   %eax
     676:	68 b0 3f 00 00       	push   $0x3fb0
     67b:	ff 35 b0 5e 00 00    	pushl  0x5eb0
     681:	e8 5a 34 00 00       	call   3ae0 <printf>
    exit();
     686:	e8 d8 32 00 00       	call   3963 <exit>
...
00000690 <writetest1>:
{
  ...
  printf(stdout, "big files test\n");
     ...
     6a1:	ff 35 b0 5e 00 00    	pushl  0x5eb0
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     6b8:	e8 e6 32 00 00       	call   39a3 <open>
  if(fd < 0){
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    ((int*)buf)[0] = i;
     6d3:	89 1d a0 86 00 00    	mov    %ebx,0x86a0
    if(write(fd, buf, 512) != 512){
     6d9:	68 00 02 00 00       	push   $0x200
     6de:	68 a0 86 00 00       	push   $0x86a0
     6e3:	56                   	push   %esi
     6e4:	e8 9a 32 00 00       	call   3983 <write>
  ...
  close(fd);
     ...
     705:	56                   	push   %esi
     706:	e8 80 32 00 00       	call   398b <close>
  fd = open("big", O_RDONLY);
     70b:	5b                   	pop    %ebx
     70c:	5e                   	pop    %esi
     70d:	6a 00                	push   $0x0
     70f:	68 d7 40 00 00       	push   $0x40d7
     714:	e8 8a 32 00 00       	call   39a3 <open>
  if(fd < 0){
  ...
  n = 0;
    ...
    if(((int*)buf)[0] != n){
     73b:	a1 a0 86 00 00       	mov    0x86a0,%eax
    ...
    i = read(fd, buf, 512);
     ...
     74f:	68 a0 86 00 00       	push   $0x86a0
     754:	53                   	push   %ebx
     755:	e8 21 32 00 00       	call   397b <read>
    if(i == 0){
  ...
  close(fd);
     ...
     770:	53                   	push   %ebx
     771:	e8 15 32 00 00       	call   398b <close>
  if(unlink("big") < 0){
     776:	c7 04 24 d7 40 00 00 	movl   $0x40d7,(%esp)
     77d:	e8 31 32 00 00       	call   39b3 <unlink>
  ...
  printf(stdout, "big files ok\n");
     ...
     795:	ff 35 b0 5e 00 00    	pushl  0x5eb0
     ...
     7b3:	ff 35 b0 5e 00 00    	pushl  0x5eb0
     ...
     868:	bb 30 00 00 00       	mov    $0x30,%ebx
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     ...
     875:	ff 35 b0 5e 00 00    	pushl  0x5eb0
     87b:	e8 60 32 00 00       	call   3ae0 <printf>
  name[0] = 'a';
     880:	c6 05 a0 a6 00 00 61 	movb   $0x61,0xa6a0
  name[2] = '\0';
     887:	83 c4 10             	add    $0x10,%esp
     88a:	c6 05 a2 a6 00 00 00 	movb   $0x0,0xa6a2
  for(i = 0; i < 52; i++){
     891:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    fd = open(name, O_CREATE|O_RDWR);
     898:	83 ec 08             	sub    $0x8,%esp
    name[1] = '0' + i;
     89b:	88 1d a1 a6 00 00    	mov    %bl,0xa6a1
    fd = open(name, O_CREATE|O_RDWR);
     8a1:	83 c3 01             	add    $0x1,%ebx
     8a4:	68 02 02 00 00       	push   $0x202
     8a9:	68 a0 a6 00 00       	push   $0xa6a0
     8ae:	e8 f0 30 00 00       	call   39a3 <open>
    close(fd);
     8b3:	89 04 24             	mov    %eax,(%esp)
     8b6:	e8 d0 30 00 00       	call   398b <close>
  for(i = 0; i < 52; i++){
     8bb:	83 c4 10             	add    $0x10,%esp
     8be:	80 fb 64             	cmp    $0x64,%bl
     8c1:	75 d5                	jne    898 <createtest+0x38>
  name[0] = 'a';
     8c3:	c6 05 a0 a6 00 00 61 	movb   $0x61,0xa6a0
  name[2] = '\0';
     8ca:	bb 30 00 00 00       	mov    $0x30,%ebx
     8cf:	c6 05 a2 a6 00 00 00 	movb   $0x0,0xa6a2
  for(i = 0; i < 52; i++){
    ...
    name[1] = '0' + i;
     8e3:	88 1d a1 a6 00 00    	mov    %bl,0xa6a1
    unlink(name);
     8e9:	83 c3 01             	add    $0x1,%ebx
     8ec:	68 a0 a6 00 00       	push   $0xa6a0
     8f1:	e8 bd 30 00 00       	call   39b3 <unlink>
  for(i = 0; i < 52; i++){
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     906:	ff 35 b0 5e 00 00    	pushl  0x5eb0
...
00000920 <dirtest>:
{
  ...
  if(chdir("dir0") < 0){
     ...
     955:	e8 79 30 00 00       	call   39d3 <chdir>
  ...
  if(chdir("..") < 0){
     ...
     96d:	e8 61 30 00 00       	call   39d3 <chdir>
  ...
  if(unlink("dir0") < 0){
     ...
     981:	e8 2d 30 00 00       	call   39b3 <unlink>
  ...
  printf(stdout, "mkdir test ok\n");
     ...
     995:	ff 35 b0 5e 00 00    	pushl  0x5eb0
    ...
    printf(stdout, "mkdir failed\n");
     ...
     9ac:	ff 35 b0 5e 00 00    	pushl  0x5eb0
     9b2:	e8 29 31 00 00       	call   3ae0 <printf>
    exit();
     9b7:	e8 a7 2f 00 00       	call   3963 <exit>
    printf(stdout, "unlink dir0 failed\n");
     9bc:	50                   	push   %eax
     9bd:	50                   	push   %eax
     9be:	68 41 41 00 00       	push   $0x4141
     9c3:	ff 35 b0 5e 00 00    	pushl  0x5eb0
     9c9:	e8 12 31 00 00       	call   3ae0 <printf>
    exit();
     9ce:	e8 90 2f 00 00       	call   3963 <exit>
    printf(stdout, "chdir .. failed\n");
     9d3:	52                   	push   %edx
     9d4:	52                   	push   %edx
     9d5:	68 30 41 00 00       	push   $0x4130
     9da:	ff 35 b0 5e 00 00    	pushl  0x5eb0
     9e0:	e8 fb 30 00 00       	call   3ae0 <printf>
    exit();
     9e5:	e8 79 2f 00 00       	call   3963 <exit>
    printf(stdout, "chdir dir0 failed\n");
     9ea:	51                   	push   %ecx
     9eb:	51                   	push   %ecx
     9ec:	68 1d 41 00 00       	push   $0x411d
     9f1:	ff 35 b0 5e 00 00    	pushl  0x5eb0
     9f7:	e8 e4 30 00 00       	call   3ae0 <printf>
    exit();
     9fc:	e8 62 2f 00 00       	call   3963 <exit>
...
00000a10 <exectest>:
{
  ...
  printf(stdout, "exec test\n");
     ...
     a1f:	ff 35 b0 5e 00 00    	pushl  0x5eb0
     a25:	e8 b6 30 00 00       	call   3ae0 <printf>
  if(exec("echo", echoargv) < 0){
     a2a:	5a                   	pop    %edx
     a2b:	59                   	pop    %ecx
     a2c:	68 b4 5e 00 00       	push   $0x5eb4
     a31:	68 2d 3f 00 00       	push   $0x3f2d
     a36:	e8 60 2f 00 00       	call   399b <exec>
    ...
    printf(stdout, "exec echo failed\n");
     ...
     a4b:	ff 35 b0 5e 00 00    	pushl  0x5eb0
     a51:	e8 8a 30 00 00       	call   3ae0 <printf>
    exit();
     a56:	e8 08 2f 00 00       	call   3963 <exit>
     ...
     a69:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
  ...
  seq = 0;
    ...
    close(fds[1]);
     aa1:	e8 e5 2e 00 00       	call   398b <close>
    total = 0;
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     ab3:	56                   	push   %esi
     ab4:	68 a0 86 00 00       	push   $0x86a0
     ab9:	ff 75 e0             	pushl  -0x20(%ebp)
     abc:	e8 ba 2e 00 00       	call   397b <read>
     ...
     add:	38 90 a0 86 00 00    	cmp    %dl,0x86a0(%eax)
  ...
  seq = 0;
    ...
    close(fds[0]);
     b23:	e8 63 2e 00 00       	call   398b <close>
     ...
     b33:	83 c0 01             	add    $0x1,%eax
        buf[i] = seq++;
     b36:	88 90 9f 86 00 00    	mov    %dl,0x869f(%eax)
      for(i = 0; i < 1033; i++)
     ...
     b51:	68 a0 86 00 00       	push   $0x86a0
     b56:	ff 75 e4             	pushl  -0x1c(%ebp)
     b59:	e8 25 2e 00 00       	call   3983 <write>
    ...
    exit();
     b70:	e8 ee 2d 00 00       	call   3963 <exit>
    if(total != 5 * 1033){
    ...
    close(fds[0]);
     ...
     b84:	e8 02 2e 00 00       	call   398b <close>
    wait();
     b89:	e8 dd 2d 00 00       	call   396b <wait>
  printf(1, "pipe1 ok\n");
     b8e:	5a                   	pop    %edx
     b8f:	59                   	pop    %ecx
     ...
     baf:	e8 2c 2f 00 00       	call   3ae0 <printf>
      exit();
     bb4:	e8 aa 2d 00 00       	call   3963 <exit>
    ...
    exit();
     bc7:	e8 97 2d 00 00       	call   3963 <exit>
    ...
    exit();
     bda:	e8 84 2d 00 00       	call   3963 <exit>
     ...
     be8:	e8 f3 2e 00 00       	call   3ae0 <printf>
        exit();
     bed:	e8 71 2d 00 00       	call   3963 <exit>
...
00000c00 <preempt>:
{
  ...
  pid1 = fork();
     c19:	e8 3d 2d 00 00       	call   395b <fork>
  if(pid1 == 0)
  ...
  pid2 = fork();
     c32:	e8 24 2d 00 00       	call   395b <fork>
  ...
  pipe(pfds);
     ...
     c46:	50                   	push   %eax
     c47:	e8 27 2d 00 00       	call   3973 <pipe>
  pid3 = fork();
     c4c:	e8 0a 2d 00 00       	call   395b <fork>
  if(pid3 == 0){
  ...
  if(pid3 == 0){
    ...
    close(pfds[1]);
     ...
     c89:	e8 fd 2c 00 00       	call   398b <close>
  ...
  close(pfds[1]);
     ...
     c9e:	e8 e8 2c 00 00       	call   398b <close>
  if(read(pfds[0], buf, sizeof(buf)) != 1){
     ca3:	83 c4 0c             	add    $0xc,%esp
     ca6:	68 00 20 00 00       	push   $0x2000
     cab:	68 a0 86 00 00       	push   $0x86a0
     cb0:	ff 75 e0             	pushl  -0x20(%ebp)
     cb3:	e8 c3 2c 00 00       	call   397b <read>
  ...
  close(pfds[0]);
     ...
     cc6:	e8 c0 2c 00 00       	call   398b <close>
  printf(1, "kill... ");
     ccb:	58                   	pop    %eax
     ccc:	5a                   	pop    %edx
  ...
  kill(pid1);
     ...
     cdc:	e8 b2 2c 00 00       	call   3993 <kill>
  kill(pid2);
     ce1:	89 34 24             	mov    %esi,(%esp)
     ce4:	e8 aa 2c 00 00       	call   3993 <kill>
  kill(pid3);
     ce9:	89 1c 24             	mov    %ebx,(%esp)
     cec:	e8 a2 2c 00 00       	call   3993 <kill>
  printf(1, "wait... ");
     cf1:	59                   	pop    %ecx
     cf2:	5b                   	pop    %ebx
  ...
  wait();
     cff:	e8 67 2c 00 00       	call   396b <wait>
  wait();
     d04:	e8 62 2c 00 00       	call   396b <wait>
  wait();
     d09:	e8 5d 2c 00 00       	call   396b <wait>
  printf(1, "preempt ok\n");
     d0e:	5e                   	pop    %esi
     d0f:	5f                   	pop    %edi
...
00000d60 <exitwait>:
{
    ...
    if(pid){
     d70:	74 68                	je     dda <exitwait+0x7a>
      if(wait() != pid){
     d72:	e8 f4 2b 00 00       	call   396b <wait>
  ...
  for(i = 0; i < 100; i++){
    ...
    pid = fork();
     d80:	e8 d6 2b 00 00       	call   395b <fork>
  ...
  printf(1, "exitwait ok\n");
     ...
     dd9:	c3                   	ret    
      exit();
     dda:	e8 84 2b 00 00       	call   3963 <exit>
     ddf:	90                   	nop
...
00000de0 <mem>:
{
  ...
  ppid = getpid();
     dfa:	e8 e4 2b 00 00       	call   39e3 <getpid>
     dff:	89 c3                	mov    %eax,%ebx
  if((pid = fork()) == 0){
     e01:	e8 55 2b 00 00       	call   395b <fork>
    ...
    exit();
     e77:	e8 e7 2a 00 00       	call   3963 <exit>
     ...
     e92:	e8 fc 2a 00 00       	call   3993 <kill>
      exit();
     e97:	e8 c7 2a 00 00       	call   3963 <exit>
     ...
     ea5:	5d                   	pop    %ebp
    wait();
     ea6:	e9 c0 2a 00 00       	jmp    396b <wait>
...
00000eb0 <sharedfd>:
{
  ...
  unlink("sharedfd");
     ...
     ed0:	e8 de 2a 00 00       	call   39b3 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     ed5:	5b                   	pop    %ebx
     ed6:	5e                   	pop    %esi
     ed7:	68 02 02 00 00       	push   $0x202
     edc:	68 83 42 00 00       	push   $0x4283
     ee1:	e8 bd 2a 00 00       	call   39a3 <open>
  if(fd < 0){
  ...
  pid = fork();
     efb:	e8 5b 2a 00 00       	call   395b <fork>
  memset(buf, pid==0?'c':'p', sizeof(buf));
  ...
  memset(buf, pid==0?'c':'p', sizeof(buf));
     ...
     f13:	50                   	push   %eax
     f14:	56                   	push   %esi
     f15:	e8 a6 28 00 00       	call   37c0 <memset>
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     f2a:	56                   	push   %esi
     f2b:	57                   	push   %edi
     f2c:	e8 52 2a 00 00       	call   3983 <write>
  ...
  if(pid == 0)
    ...
    wait();
     f56:	e8 10 2a 00 00       	call   396b <wait>
  close(fd);
  ...
  close(fd);
     ...
     f64:	e8 22 2a 00 00       	call   398b <close>
  fd = open("sharedfd", 0);
     f69:	58                   	pop    %eax
     f6a:	5a                   	pop    %edx
     f6b:	6a 00                	push   $0x0
     f6d:	68 83 42 00 00       	push   $0x4283
     f72:	e8 2c 2a 00 00       	call   39a3 <open>
  if(fd < 0){
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     f9c:	e8 da 29 00 00       	call   397b <read>
  ...
  close(fd);
     ...
     fd6:	e8 b0 29 00 00       	call   398b <close>
  unlink("sharedfd");
     fdb:	c7 04 24 83 42 00 00 	movl   $0x4283,(%esp)
     fe2:	e8 cc 29 00 00       	call   39b3 <unlink>
  if(nc == 10000 && np == 10000){
    ...
    104a:	c3                   	ret    
    exit();
    104b:	e8 13 29 00 00       	call   3963 <exit>
    ...
    exit();
    105e:	e8 00 29 00 00       	call   3963 <exit>
    ...
    107f:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fourfiles test\n");
    ...
    10b2:	56                   	push   %esi
    10b3:	e8 fb 28 00 00       	call   39b3 <unlink>
    pid = fork();
    10b8:	e8 9e 28 00 00       	call   395b <fork>
    if(pid < 0){
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    wait();
    10dc:	e8 8a 28 00 00       	call   396b <wait>
  for(i = 0; i < 2; i++){
    10e1:	31 f6                	xor    %esi,%esi
    wait();
    10e3:	e8 83 28 00 00       	call   396b <wait>
    10e8:	e8 7e 28 00 00       	call   396b <wait>
    10ed:	e8 79 28 00 00       	call   396b <wait>
    fname = names[i];
    ...
    fd = open(fname, 0);
    1101:	e8 9d 28 00 00       	call   39a3 <open>
    while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    1118:	68 a0 86 00 00       	push   $0x86a0
    111d:	ff 75 d4             	pushl  -0x2c(%ebp)
    1120:	e8 56 28 00 00       	call   397b <read>
    ...
    1133:	0f be ba a0 86 00 00 	movsbl 0x86a0(%edx),%edi
    ...
    1154:	e8 32 28 00 00       	call   398b <close>
    if(total != 12*500){
    ...
    116e:	e8 40 28 00 00       	call   39b3 <unlink>
  for(i = 0; i < 2; i++){
  ...
  printf(1, "fourfiles ok\n");
    ...
    11a9:	e8 32 29 00 00       	call   3ae0 <printf>
          exit();
    11ae:	e8 b0 27 00 00       	call   3963 <exit>
      fd = open(fname, O_CREATE | O_RDWR);
    11b3:	83 ec 08             	sub    $0x8,%esp
    11b6:	68 02 02 00 00       	push   $0x202
    11bb:	56                   	push   %esi
    11bc:	e8 e2 27 00 00       	call   39a3 <open>
      if(fd < 0){
    ...
    11db:	68 a0 86 00 00       	push   $0x86a0
    11e0:	e8 db 25 00 00       	call   37c0 <memset>
    11e5:	83 c4 10             	add    $0x10,%esp
        if((n = write(fd, buf, 500)) != 500){
    11e8:	83 ec 04             	sub    $0x4,%esp
    11eb:	68 f4 01 00 00       	push   $0x1f4
    11f0:	68 a0 86 00 00       	push   $0x86a0
    11f5:	56                   	push   %esi
    11f6:	e8 88 27 00 00       	call   3983 <write>
    ...
    1208:	75 de                	jne    11e8 <fourfiles+0x178>
      exit();
    120a:	e8 54 27 00 00       	call   3963 <exit>
    ...
    1218:	e8 c3 28 00 00       	call   3ae0 <printf>
        exit();
    121d:	e8 41 27 00 00       	call   3963 <exit>
    ...
    1232:	e8 a9 28 00 00       	call   3ae0 <printf>
      exit();
    1237:	e8 27 27 00 00       	call   3963 <exit>
    ...
    1245:	e8 96 28 00 00       	call   3ae0 <printf>
      exit();
    124a:	e8 14 27 00 00       	call   3963 <exit>
    ...
    1258:	e8 83 28 00 00       	call   3ae0 <printf>
          exit();
    125d:	e8 01 27 00 00       	call   3963 <exit>
    ...
    127a:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "createdelete test\n");
    ...
    pid = fork();
    128e:	e8 c8 26 00 00       	call   395b <fork>
    if(pid < 0){
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    wait();
    12a9:	e8 bd 26 00 00       	call   396b <wait>
    12ae:	8d 7d c8             	lea    -0x38(%ebp),%edi
  name[0] = name[1] = name[2] = 0;
    12b1:	be ff ff ff ff       	mov    $0xffffffff,%esi
    wait();
    12b6:	e8 b0 26 00 00       	call   396b <wait>
    12bb:	e8 ab 26 00 00       	call   396b <wait>
    12c0:	e8 a6 26 00 00       	call   396b <wait>
  name[0] = name[1] = name[2] = 0;
  ...
  for(i = 0; i < N; i++){
    ...
    12ff:	88 45 c9             	mov    %al,-0x37(%ebp)
      fd = open(name, 0);
    1302:	e8 9c 26 00 00       	call   39a3 <open>
      if((i == 0 || i >= N/2) && fd < 0){
    ...
    1328:	50                   	push   %eax
    1329:	e8 5d 26 00 00       	call   398b <close>
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1368:	88 45 c9             	mov    %al,-0x37(%ebp)
      unlink(name);
    136b:	e8 43 26 00 00       	call   39b3 <unlink>
    for(pi = 0; pi < 4; pi++){
  ...
  printf(1, "createdelete ok\n");
    ...
    13e4:	88 45 c9             	mov    %al,-0x37(%ebp)
        fd = open(name, O_CREATE | O_RDWR);
    13e7:	e8 b7 25 00 00       	call   39a3 <open>
        if(fd < 0){
    ...
    13f6:	50                   	push   %eax
    13f7:	e8 8f 25 00 00       	call   398b <close>
        if(i > 0 && (i % 2 ) == 0){
    ...
    1413:	88 45 c9             	mov    %al,-0x37(%ebp)
          if(unlink(name) < 0){
    1416:	e8 98 25 00 00       	call   39b3 <unlink>
    ...
    142b:	e8 b0 26 00 00       	call   3ae0 <printf>
            exit();
    1430:	e8 2e 25 00 00       	call   3963 <exit>
    1435:	8d 76 00             	lea    0x0(%esi),%esi
      exit();
    1438:	e8 26 25 00 00       	call   3963 <exit>
    ...
    144b:	e8 90 26 00 00       	call   3ae0 <printf>
        exit();
    1450:	e8 0e 25 00 00       	call   3963 <exit>
          printf(1, "create failed\n");
    ...
    145f:	e8 7c 26 00 00       	call   3ae0 <printf>
          exit();
    1464:	e8 fa 24 00 00       	call   3963 <exit>
      printf(1, "fork failed\n");
    ...
    1473:	e8 68 26 00 00       	call   3ae0 <printf>
      exit();
    1478:	e8 e6 24 00 00       	call   3963 <exit>
      } else if((i >= 1 && i < N/2) && fd >= 0){
    ...
    1491:	e8 4a 26 00 00       	call   3ae0 <printf>
        exit();
    1496:	e8 c8 24 00 00       	call   3963 <exit>
...
000014a0 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
    ...
    14c4:	e8 da 24 00 00       	call   39a3 <open>
  if(fd < 0){
  ...
  write(fd, "hello", 5);
    ...
    14e0:	50                   	push   %eax
    14e1:	e8 9d 24 00 00       	call   3983 <write>
  close(fd);
    14e6:	89 1c 24             	mov    %ebx,(%esp)
    14e9:	e8 9d 24 00 00       	call   398b <close>
  fd = open("unlinkread", O_RDWR);
    14ee:	58                   	pop    %eax
    14ef:	5a                   	pop    %edx
    14f0:	6a 02                	push   $0x2
    14f2:	68 35 43 00 00       	push   $0x4335
    14f7:	e8 a7 24 00 00       	call   39a3 <open>
  if(fd < 0){
  ...
  if(unlink("unlinkread") != 0){
    ...
    1511:	e8 9d 24 00 00       	call   39b3 <unlink>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    152e:	e8 70 24 00 00       	call   39a3 <open>
  write(fd1, "yyy", 3);
  ...
  close(fd);
    ...
    1590:	53                   	push   %ebx
    1591:	e8 f5 23 00 00       	call   398b <close>
  unlink("unlinkread");
    1596:	c7 04 24 35 43 00 00 	movl   $0x4335,(%esp)
    159d:	e8 11 24 00 00       	call   39b3 <unlink>
  printf(1, "unlinkread ok\n");
    ...
    exit();
    15c8:	e8 96 23 00 00       	call   3963 <exit>
    ...
    exit();
    15db:	e8 83 23 00 00       	call   3963 <exit>
    ...
    exit();
    15ee:	e8 70 23 00 00       	call   3963 <exit>
    ...
    exit();
    1601:	e8 5d 23 00 00       	call   3963 <exit>
    ...
    exit();
    1614:	e8 4a 23 00 00       	call   3963 <exit>
    ...
    exit();
    1627:	e8 37 23 00 00       	call   3963 <exit>
...
00001630 <linktest>:
{
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    1687:	50                   	push   %eax
    1688:	e8 f6 22 00 00       	call   3983 <write>
  ...
  close(fd);
    ...
    169c:	53                   	push   %ebx
    169d:	e8 e9 22 00 00       	call   398b <close>
  if(link("lf1", "lf2") < 0){
    16a2:	5b                   	pop    %ebx
    16a3:	58                   	pop    %eax
    16a4:	68 fa 43 00 00       	push   $0x43fa
    16a9:	68 f6 43 00 00       	push   $0x43f6
    16ae:	e8 10 23 00 00       	call   39c3 <link>
  ...
  unlink("lf1");
    ...
    16c6:	e8 e8 22 00 00       	call   39b3 <unlink>
  if(open("lf1", 0) >= 0){
    16cb:	58                   	pop    %eax
    16cc:	5a                   	pop    %edx
    16cd:	6a 00                	push   $0x0
    16cf:	68 f6 43 00 00       	push   $0x43f6
    16d4:	e8 ca 22 00 00       	call   39a3 <open>
  ...
  fd = open("lf2", 0);
    ...
    16ee:	e8 b0 22 00 00       	call   39a3 <open>
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1708:	68 a0 86 00 00       	push   $0x86a0
    170d:	50                   	push   %eax
    170e:	e8 68 22 00 00       	call   397b <read>
  ...
  close(fd);
    ...
    1722:	53                   	push   %ebx
    1723:	e8 63 22 00 00       	call   398b <close>
  if(link("lf2", "lf2") >= 0){
    1728:	58                   	pop    %eax
    1729:	5a                   	pop    %edx
    172a:	68 fa 43 00 00       	push   $0x43fa
    172f:	68 fa 43 00 00       	push   $0x43fa
    1734:	e8 8a 22 00 00       	call   39c3 <link>
  ...
  unlink("lf2");
    ...
    174c:	e8 62 22 00 00       	call   39b3 <unlink>
  if(link("lf2", "lf1") >= 0){
    1751:	59                   	pop    %ecx
    1752:	5b                   	pop    %ebx
    1753:	68 f6 43 00 00       	push   $0x43f6
    1758:	68 fa 43 00 00       	push   $0x43fa
    175d:	e8 61 22 00 00       	call   39c3 <link>
  ...
  if(link(".", "lf1") >= 0){
    ...
    1776:	e8 48 22 00 00       	call   39c3 <link>
  ...
  printf(1, "linktest ok\n");
    ...
    exit();
    17a7:	e8 b7 21 00 00       	call   3963 <exit>
    ...
    exit();
    17ba:	e8 a4 21 00 00       	call   3963 <exit>
    ...
    exit();
    17cd:	e8 91 21 00 00       	call   3963 <exit>
    ...
    exit();
    17e0:	e8 7e 21 00 00       	call   3963 <exit>
    ...
    exit();
    17f3:	e8 6b 21 00 00       	call   3963 <exit>
    ...
    exit();
    1806:	e8 58 21 00 00       	call   3963 <exit>
    ...
    exit();
    1819:	e8 45 21 00 00       	call   3963 <exit>
    ...
    exit();
    182c:	e8 32 21 00 00       	call   3963 <exit>
    ...
    exit();
    183f:	e8 1f 21 00 00       	call   3963 <exit>
    ...
    1859:	31 f6                	xor    %esi,%esi
{
  ...
  for(i = 0; i < 40; i++){
    ...
    1899:	53                   	push   %ebx
    189a:	e8 04 21 00 00       	call   39a3 <open>
      if(fd < 0){
  ...
  for(i = 0; i < 40; i++){
    18a9:	83 c6 01             	add    $0x1,%esi
      close(fd);
    18ac:	50                   	push   %eax
    18ad:	e8 d9 20 00 00       	call   398b <close>
    18b2:	83 c4 10             	add    $0x10,%esp
      wait();
    18b5:	e8 b1 20 00 00       	call   396b <wait>
  for(i = 0; i < 40; i++){
    ...
    unlink(file);
    18cd:	e8 e1 20 00 00       	call   39b3 <unlink>
    pid = fork();
    18d2:	e8 84 20 00 00       	call   395b <fork>
    if(pid && (i % 3) == 1){
    ...
    18f4:	53                   	push   %ebx
    18f5:	e8 a9 20 00 00       	call   39a3 <open>
      if(fd < 0){
  ...
  for(i = 0; i < 40; i++){
    ...
    194c:	e8 72 20 00 00       	call   39c3 <link>
    1951:	83 c4 10             	add    $0x10,%esp
      wait();
    1954:	e8 12 20 00 00       	call   396b <wait>
  for(i = 0; i < 40; i++){
  ...
  memset(fa, 0, sizeof(fa));
    ...
    196a:	6a 00                	push   $0x0
    196c:	50                   	push   %eax
    196d:	e8 4e 1e 00 00       	call   37c0 <memset>
  fd = open(".", 0);
    1972:	5e                   	pop    %esi
    1973:	5f                   	pop    %edi
    1974:	6a 00                	push   $0x0
    ...
    197e:	e8 20 20 00 00       	call   39a3 <open>
  n = 0;
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1995:	57                   	push   %edi
    1996:	56                   	push   %esi
    1997:	e8 df 1f 00 00       	call   397b <read>
  ...
  close(fd);
    ...
    19e3:	56                   	push   %esi
    19e4:	e8 a2 1f 00 00       	call   398b <close>
  if(n != 40){
  ...
  for(i = 0; i < 40; i++){
    ...
    1a0c:	53                   	push   %ebx
    1a0d:	e8 a1 1f 00 00       	call   39b3 <unlink>
      unlink(file);
    1a12:	89 1c 24             	mov    %ebx,(%esp)
    1a15:	e8 99 1f 00 00       	call   39b3 <unlink>
      unlink(file);
    1a1a:	89 1c 24             	mov    %ebx,(%esp)
    1a1d:	e8 91 1f 00 00       	call   39b3 <unlink>
      unlink(file);
    1a22:	89 1c 24             	mov    %ebx,(%esp)
    1a25:	e8 89 1f 00 00       	call   39b3 <unlink>
    1a2a:	83 c4 10             	add    $0x10,%esp
    if(pid == 0)
    1a2d:	85 ff                	test   %edi,%edi
    1a2f:	0f 84 fc fe ff ff    	je     1931 <concreate+0xe1>
      wait();
    1a35:	e8 31 1f 00 00       	call   396b <wait>
  for(i = 0; i < 40; i++){
    ...
    pid = fork();
    1a4c:	e8 0a 1f 00 00       	call   395b <fork>
    ...
    1a78:	6a 00                	push   $0x0
    1a7a:	53                   	push   %ebx
    1a7b:	e8 23 1f 00 00       	call   39a3 <open>
    1a80:	89 04 24             	mov    %eax,(%esp)
    1a83:	e8 03 1f 00 00       	call   398b <close>
      close(open(file, 0));
    1a88:	58                   	pop    %eax
    1a89:	5a                   	pop    %edx
    1a8a:	6a 00                	push   $0x0
    1a8c:	53                   	push   %ebx
    1a8d:	e8 11 1f 00 00       	call   39a3 <open>
    1a92:	89 04 24             	mov    %eax,(%esp)
    1a95:	e8 f1 1e 00 00       	call   398b <close>
      close(open(file, 0));
    1a9a:	59                   	pop    %ecx
    1a9b:	58                   	pop    %eax
    1a9c:	6a 00                	push   $0x0
    1a9e:	53                   	push   %ebx
    1a9f:	e8 ff 1e 00 00       	call   39a3 <open>
    1aa4:	89 04 24             	mov    %eax,(%esp)
    1aa7:	e8 df 1e 00 00       	call   398b <close>
      close(open(file, 0));
    1aac:	58                   	pop    %eax
    1aad:	5a                   	pop    %edx
    1aae:	6a 00                	push   $0x0
    1ab0:	53                   	push   %ebx
    1ab1:	e8 ed 1e 00 00       	call   39a3 <open>
    1ab6:	89 04 24             	mov    %eax,(%esp)
    1ab9:	e8 cd 1e 00 00       	call   398b <close>
  ...
  printf(1, "concreate ok\n");
    ...
    1af1:	e8 ea 1f 00 00       	call   3ae0 <printf>
      exit();
    1af6:	e8 68 1e 00 00       	call   3963 <exit>
    ...
    1b1c:	e8 bf 1f 00 00       	call   3ae0 <printf>
        exit();
    1b21:	e8 3d 1e 00 00       	call   3963 <exit>
    ...
    1b34:	e8 a7 1f 00 00       	call   3ae0 <printf>
        exit();
    1b39:	e8 25 1e 00 00       	call   3963 <exit>
      close(fd);
    1b3e:	83 ec 0c             	sub    $0xc,%esp
    1b41:	50                   	push   %eax
    1b42:	e8 44 1e 00 00       	call   398b <close>
...
00001b50 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1b70:	e8 3e 1e 00 00       	call   39b3 <unlink>
  pid = fork();
    1b75:	e8 e1 1d 00 00       	call   395b <fork>
  if(pid < 0){
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1bad:	e8 01 1e 00 00       	call   39b3 <unlink>
  ...
  for(i = 0; i < 100; i++){
    ...
    1be6:	e8 b8 1d 00 00       	call   39a3 <open>
    1beb:	89 04 24             	mov    %eax,(%esp)
    1bee:	e8 98 1d 00 00       	call   398b <close>
  ...
  if(pid)
    ...
    wait();
    1c02:	e8 64 1d 00 00       	call   396b <wait>
  printf(1, "linkunlink ok\n");
    ...
    1c2d:	e8 91 1d 00 00       	call   39c3 <link>
    ...
    exit();
    1c48:	e8 16 1d 00 00       	call   3963 <exit>
    exit();
    1c4d:	e8 11 1d 00 00       	call   3963 <exit>
...
00001c60 <bigdir>:
{
  ...
  unlink("bd");
    ...
    1c80:	e8 2e 1d 00 00       	call   39b3 <unlink>
  fd = open("bd", O_CREATE);
    1c85:	5a                   	pop    %edx
    1c86:	59                   	pop    %ecx
    1c87:	68 00 02 00 00       	push   $0x200
    1c8c:	68 45 45 00 00       	push   $0x4545
    1c91:	e8 0d 1d 00 00       	call   39a3 <open>
  if(fd < 0){
  ...
  close(fd);
    1ca9:	50                   	push   %eax
    1caa:	e8 dc 1c 00 00       	call   398b <close>
    ...
    if(link("bd", name) != 0){
    1cdf:	e8 df 1c 00 00       	call   39c3 <link>
  ...
  unlink("bd");
    ...
    1d00:	e8 ae 1c 00 00       	call   39b3 <unlink>
    ...
    if(unlink(name) != 0){
    1d32:	e8 7c 1c 00 00       	call   39b3 <unlink>
  ...
  printf(1, "bigdir ok\n");
    ...
    1d6d:	e8 6e 1d 00 00       	call   3ae0 <printf>
      exit();
    1d72:	e8 ec 1b 00 00       	call   3963 <exit>
    ...
    1d81:	e8 5a 1d 00 00       	call   3ae0 <printf>
      exit();
    1d86:	e8 d8 1b 00 00       	call   3963 <exit>
    ...
    exit();
    1d99:	e8 c5 1b 00 00       	call   3963 <exit>
...
00001da0 <subdir>:
{
  ...
  unlink("ff");
    ...
    1dbe:	e8 f0 1b 00 00       	call   39b3 <unlink>
  if(mkdir("dd") != 0){
    1dc3:	c7 04 24 b8 46 00 00 	movl   $0x46b8,(%esp)
    1dca:	e8 fc 1b 00 00       	call   39cb <mkdir>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1de7:	e8 b7 1b 00 00       	call   39a3 <open>
  if(fd < 0){
  ...
  write(fd, "ff", 2);
    ...
    1e03:	50                   	push   %eax
    1e04:	e8 7a 1b 00 00       	call   3983 <write>
  close(fd);
    1e09:	89 1c 24             	mov    %ebx,(%esp)
    1e0c:	e8 7a 1b 00 00       	call   398b <close>
  if(unlink("dd") >= 0){
    1e11:	c7 04 24 b8 46 00 00 	movl   $0x46b8,(%esp)
    1e18:	e8 96 1b 00 00       	call   39b3 <unlink>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    1e30:	e8 96 1b 00 00       	call   39cb <mkdir>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1e4d:	e8 51 1b 00 00       	call   39a3 <open>
  if(fd < 0){
  ...
  write(fd, "FF", 2);
    ...
    1e69:	50                   	push   %eax
    1e6a:	e8 14 1b 00 00       	call   3983 <write>
  close(fd);
    1e6f:	89 1c 24             	mov    %ebx,(%esp)
    1e72:	e8 14 1b 00 00       	call   398b <close>
  fd = open("dd/dd/../ff", 0);
    1e77:	58                   	pop    %eax
    1e78:	5a                   	pop    %edx
    1e79:	6a 00                	push   $0x0
    1e7b:	68 12 46 00 00       	push   $0x4612
    1e80:	e8 1e 1b 00 00       	call   39a3 <open>
  if(fd < 0){
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    1eeb:	e8 c3 1a 00 00       	call   39b3 <unlink>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1f05:	e8 99 1a 00 00       	call   39a3 <open>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    1f4d:	e8 81 1a 00 00       	call   39d3 <chdir>
  ...
  if(chdir("./..") != 0){
    ...
    1f65:	e8 69 1a 00 00       	call   39d3 <chdir>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1f7f:	e8 1f 1a 00 00       	call   39a3 <open>
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    1f99:	68 a0 86 00 00       	push   $0x86a0
    1f9e:	50                   	push   %eax
    1f9f:	e8 d7 19 00 00       	call   397b <read>
  ...
  close(fd);
    ...
    1fb3:	53                   	push   %ebx
    1fb4:	e8 d2 19 00 00       	call   398b <close>
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    1fb9:	58                   	pop    %eax
    1fba:	5a                   	pop    %edx
    1fbb:	6a 00                	push   $0x0
    1fbd:	68 ee 45 00 00       	push   $0x45ee
    1fc2:	e8 dc 19 00 00       	call   39a3 <open>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1fdf:	e8 bf 19 00 00       	call   39a3 <open>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1ffc:	e8 a2 19 00 00       	call   39a3 <open>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    2019:	e8 85 19 00 00       	call   39a3 <open>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    2033:	e8 6b 19 00 00       	call   39a3 <open>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    204d:	e8 51 19 00 00       	call   39a3 <open>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    206a:	e8 54 19 00 00       	call   39c3 <link>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    2087:	e8 37 19 00 00       	call   39c3 <link>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    20a4:	e8 1a 19 00 00       	call   39c3 <link>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    20d4:	e8 f2 18 00 00       	call   39cb <mkdir>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    20ec:	e8 da 18 00 00       	call   39cb <mkdir>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    2104:	e8 aa 18 00 00       	call   39b3 <unlink>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    211c:	e8 92 18 00 00       	call   39b3 <unlink>
  ...
  if(chdir("dd/ff") == 0){
    ...
    2134:	e8 9a 18 00 00       	call   39d3 <chdir>
  ...
  if(chdir("dd/xx") == 0){
    ...
    214c:	e8 82 18 00 00       	call   39d3 <chdir>
  ...
  if(unlink("dd/dd") < 0){
    ...
    21ac:	e8 02 18 00 00       	call   39b3 <unlink>
  ...
  if(unlink("dd") < 0){
    ...
    21c4:	e8 ea 17 00 00       	call   39b3 <unlink>
  ...
  printf(1, "subdir ok\n");
    ...
    exit();
    21f9:	e8 65 17 00 00       	call   3963 <exit>
    ...
    exit();
    220c:	e8 52 17 00 00       	call   3963 <exit>
    ...
    exit();
    221f:	e8 3f 17 00 00       	call   3963 <exit>
    ...
    exit();
    2232:	e8 2c 17 00 00       	call   3963 <exit>
    ...
    exit();
    2245:	e8 19 17 00 00       	call   3963 <exit>
    ...
    exit();
    2258:	e8 06 17 00 00       	call   3963 <exit>
    ...
    exit();
    226b:	e8 f3 16 00 00       	call   3963 <exit>
    ...
    exit();
    227e:	e8 e0 16 00 00       	call   3963 <exit>
    ...
    exit();
    2291:	e8 cd 16 00 00       	call   3963 <exit>
    ...
    exit();
    22a4:	e8 ba 16 00 00       	call   3963 <exit>
    ...
    exit();
    22b7:	e8 a7 16 00 00       	call   3963 <exit>
    ...
    exit();
    22ca:	e8 94 16 00 00       	call   3963 <exit>
    ...
    exit();
    22dd:	e8 81 16 00 00       	call   3963 <exit>
    ...
    exit();
    22f0:	e8 6e 16 00 00       	call   3963 <exit>
    ...
    exit();
    2303:	e8 5b 16 00 00       	call   3963 <exit>
    ...
    exit();
    2316:	e8 48 16 00 00       	call   3963 <exit>
    ...
    exit();
    2329:	e8 35 16 00 00       	call   3963 <exit>
    ...
    exit();
    233c:	e8 22 16 00 00       	call   3963 <exit>
    printf(1, "open (unlinked) dd/dd/ff succeeded\n");
    2341:	50                   	push   %eax
    2342:	50                   	push   %eax
    ...
    exit();
    234f:	e8 0f 16 00 00       	call   3963 <exit>
    ...
    exit();
    2362:	e8 fc 15 00 00       	call   3963 <exit>
    ...
    exit();
    2375:	e8 e9 15 00 00       	call   3963 <exit>
    ...
    exit();
    2388:	e8 d6 15 00 00       	call   3963 <exit>
    ...
    exit();
    239b:	e8 c3 15 00 00       	call   3963 <exit>
    ...
    exit();
    23ae:	e8 b0 15 00 00       	call   3963 <exit>
    ...
    exit();
    23c1:	e8 9d 15 00 00       	call   3963 <exit>
    ...
    exit();
    23d4:	e8 8a 15 00 00       	call   3963 <exit>
    ...
    exit();
    23e7:	e8 77 15 00 00       	call   3963 <exit>
    ...
    exit();
    23fa:	e8 64 15 00 00       	call   3963 <exit>
    ...
    exit();
    240d:	e8 51 15 00 00       	call   3963 <exit>
    ...
    exit();
    2420:	e8 3e 15 00 00       	call   3963 <exit>
    ...
    exit();
    2433:	e8 2b 15 00 00       	call   3963 <exit>
    ...
    exit();
    2446:	e8 18 15 00 00       	call   3963 <exit>
    ...
    exit();
    2459:	e8 05 15 00 00       	call   3963 <exit>
    ...
    exit();
    246c:	e8 f2 14 00 00       	call   3963 <exit>
    ...
    exit();
    247f:	e8 df 14 00 00       	call   3963 <exit>
...
00002490 <bigwrite>:
{
  ...
  unlink("bigwrite");
    ...
    24b4:	e8 fa 14 00 00       	call   39b3 <unlink>
    ...
    24cd:	e8 d1 14 00 00       	call   39a3 <open>
    if(fd < 0){
    ...
    24de:	53                   	push   %ebx
    24df:	68 a0 86 00 00       	push   $0x86a0
    24e4:	50                   	push   %eax
    24e5:	e8 99 14 00 00       	call   3983 <write>
      if(cc != sz){
    ...
    24f4:	53                   	push   %ebx
    24f5:	68 a0 86 00 00       	push   $0x86a0
    24fa:	56                   	push   %esi
    24fb:	e8 83 14 00 00       	call   3983 <write>
      if(cc != sz){
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    close(fd);
    2510:	56                   	push   %esi
    2511:	e8 75 14 00 00       	call   398b <close>
    unlink("bigwrite");
    2516:	c7 04 24 b4 48 00 00 	movl   $0x48b4,(%esp)
    251d:	e8 91 14 00 00       	call   39b3 <unlink>
  for(sz = 499; sz < 12*512; sz += 471){
  ...
  printf(1, "bigwrite ok\n");
    ...
    254f:	e8 8c 15 00 00       	call   3ae0 <printf>
        exit();
    2554:	e8 0a 14 00 00       	call   3963 <exit>
    ...
    2563:	e8 78 15 00 00       	call   3ae0 <printf>
      exit();
    2568:	e8 f6 13 00 00       	call   3963 <exit>
...
00002570 <bigfile>:
{
  ...
  unlink("bigfile");
    ...
    2590:	e8 1e 14 00 00       	call   39b3 <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    2595:	58                   	pop    %eax
    2596:	5a                   	pop    %edx
    2597:	68 02 02 00 00       	push   $0x202
    259c:	68 10 49 00 00       	push   $0x4910
    25a1:	e8 fd 13 00 00       	call   39a3 <open>
  if(fd < 0){
  ...
  for(i = 0; i < 20; i++){
    ...
    25c0:	53                   	push   %ebx
    25c1:	68 a0 86 00 00       	push   $0x86a0
    25c6:	e8 f5 11 00 00       	call   37c0 <memset>
    if(write(fd, buf, 600) != 600){
    25cb:	83 c4 0c             	add    $0xc,%esp
    25ce:	68 58 02 00 00       	push   $0x258
    25d3:	68 a0 86 00 00       	push   $0x86a0
    25d8:	56                   	push   %esi
    25d9:	e8 a5 13 00 00       	call   3983 <write>
  ...
  close(fd);
    ...
    25f7:	56                   	push   %esi
    25f8:	e8 8e 13 00 00       	call   398b <close>
  fd = open("bigfile", 0);
    25fd:	5e                   	pop    %esi
    25fe:	5f                   	pop    %edi
    25ff:	6a 00                	push   $0x0
    2601:	68 10 49 00 00       	push   $0x4910
    2606:	e8 98 13 00 00       	call   39a3 <open>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    262d:	0f be 05 a0 86 00 00 	movsbl 0x86a0,%eax
    2634:	d1 fa                	sar    %edx
    2636:	39 d0                	cmp    %edx,%eax
    2638:	75 6e                	jne    26a8 <bigfile+0x138>
    263a:	0f be 15 cb 87 00 00 	movsbl 0x87cb,%edx
  ...
  for(i = 0; ; i++){
    ...
    2656:	68 a0 86 00 00       	push   $0x86a0
    265b:	56                   	push   %esi
    265c:	e8 1a 13 00 00       	call   397b <read>
    if(cc < 0){
  ...
  close(fd);
    ...
    266d:	56                   	push   %esi
    266e:	e8 18 13 00 00       	call   398b <close>
  if(total != 20*600){
  ...
  unlink("bigfile");
    ...
    268a:	e8 24 13 00 00       	call   39b3 <unlink>
  printf(1, "bigfile test ok\n");
    ...
    26b2:	e8 29 14 00 00       	call   3ae0 <printf>
      exit();
    26b7:	e8 a7 12 00 00       	call   3963 <exit>
    ...
    26c6:	e8 15 14 00 00       	call   3ae0 <printf>
      exit();
    26cb:	e8 93 12 00 00       	call   3963 <exit>
    ...
    26da:	e8 01 14 00 00       	call   3ae0 <printf>
      exit();
    26df:	e8 7f 12 00 00       	call   3963 <exit>
    ...
    26ee:	e8 ed 13 00 00       	call   3ae0 <printf>
      exit();
    26f3:	e8 6b 12 00 00       	call   3963 <exit>
    ...
    exit();
    2706:	e8 58 12 00 00       	call   3963 <exit>
    ...
    exit();
    2719:	e8 45 12 00 00       	call   3963 <exit>
    ...
    exit();
    272c:	e8 32 12 00 00       	call   3963 <exit>
...
00002740 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    275d:	e8 69 12 00 00       	call   39cb <mkdir>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    2775:	e8 51 12 00 00       	call   39cb <mkdir>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2792:	e8 0c 12 00 00       	call   39a3 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    27a5:	50                   	push   %eax
    27a6:	e8 e0 11 00 00       	call   398b <close>
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    27ab:	58                   	pop    %eax
    27ac:	5a                   	pop    %edx
    27ad:	6a 00                	push   $0x0
    27af:	68 68 52 00 00       	push   $0x5268
    27b4:	e8 ea 11 00 00       	call   39a3 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    27c3:	50                   	push   %eax
    27c4:	e8 c2 11 00 00       	call   398b <close>
  if(mkdir("12345678901234/12345678901234") == 0){
    27c9:	c7 04 24 dc 49 00 00 	movl   $0x49dc,(%esp)
    27d0:	e8 f6 11 00 00       	call   39cb <mkdir>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    27e4:	e8 e2 11 00 00       	call   39cb <mkdir>
  ...
  printf(1, "fourteen ok\n");
    ...
    exit();
    2812:	e8 4c 11 00 00       	call   3963 <exit>
    ...
    exit();
    2825:	e8 39 11 00 00       	call   3963 <exit>
    ...
    exit();
    2838:	e8 26 11 00 00       	call   3963 <exit>
    ...
    exit();
    284b:	e8 13 11 00 00       	call   3963 <exit>
    ...
    exit();
    285e:	e8 00 11 00 00       	call   3963 <exit>
    ...
    exit();
    2871:	e8 ed 10 00 00       	call   3963 <exit>
...
00002880 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    289d:	e8 29 11 00 00       	call   39cb <mkdir>
  ...
  if(chdir("dots") != 0){
    ...
    28b5:	e8 19 11 00 00       	call   39d3 <chdir>
  ...
  if(unlink(".") == 0){
    ...
    28cd:	e8 e1 10 00 00       	call   39b3 <unlink>
  ...
  if(chdir("/") != 0){
    ...
    28fd:	e8 d1 10 00 00       	call   39d3 <chdir>
  ...
  if(unlink("dots/.") == 0){
    ...
    2915:	e8 99 10 00 00       	call   39b3 <unlink>
  ...
  if(unlink("dots/..") == 0){
    ...
    2929:	e8 85 10 00 00       	call   39b3 <unlink>
  ...
  if(unlink("dots") != 0){
    ...
    293d:	e8 71 10 00 00       	call   39b3 <unlink>
  ...
  printf(1, "rmdot ok\n");
    ...
    exit();
    296b:	e8 f3 0f 00 00       	call   3963 <exit>
    ...
    exit();
    297e:	e8 e0 0f 00 00       	call   3963 <exit>
    ...
    exit();
    2991:	e8 cd 0f 00 00       	call   3963 <exit>
    printf(1, "unlink dots/. worked!\n");
    2996:	51                   	push   %ecx
    2997:	51                   	push   %ecx
    ...
    exit();
    29a4:	e8 ba 0f 00 00       	call   3963 <exit>
    printf(1, "chdir / failed\n");
    29a9:	50                   	push   %eax
    29aa:	50                   	push   %eax
    ...
    exit();
    29b7:	e8 a7 0f 00 00       	call   3963 <exit>
    printf(1, "rm .. worked!\n");
    29bc:	50                   	push   %eax
    29bd:	50                   	push   %eax
    ...
    exit();
    29ca:	e8 94 0f 00 00       	call   3963 <exit>
    printf(1, "rm . worked!\n");
    29cf:	50                   	push   %eax
    29d0:	50                   	push   %eax
    ...
    exit();
    29dd:	e8 81 0f 00 00       	call   3963 <exit>
    ...
    exit();
    29f0:	e8 6e 0f 00 00       	call   3963 <exit>
...
00002a00 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    2a23:	e8 7b 0f 00 00       	call   39a3 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    2a36:	50                   	push   %eax
    2a37:	e8 4f 0f 00 00       	call   398b <close>
  if(chdir("dirfile") == 0){
    2a3c:	c7 04 24 c5 4a 00 00 	movl   $0x4ac5,(%esp)
    2a43:	e8 8b 0f 00 00       	call   39d3 <chdir>
  ...
  fd = open("dirfile/xx", 0);
    ...
    2a5d:	e8 41 0f 00 00       	call   39a3 <open>
  if(fd >= 0){
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    2a7a:	e8 24 0f 00 00       	call   39a3 <open>
  if(fd >= 0){
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    2a92:	e8 34 0f 00 00       	call   39cb <mkdir>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    2aaa:	e8 04 0f 00 00       	call   39b3 <unlink>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    2ac7:	e8 f7 0e 00 00       	call   39c3 <link>
  ...
  if(unlink("dirfile") != 0){
    ...
    2adf:	e8 cf 0e 00 00       	call   39b3 <unlink>
  ...
  fd = open(".", O_RDWR);
    ...
    2af9:	e8 a5 0e 00 00       	call   39a3 <open>
  if(fd >= 0){
  ...
  fd = open(".", 0);
    ...
    2b13:	e8 8b 0e 00 00       	call   39a3 <open>
  if(write(fd, "x", 1) > 0){
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2b24:	50                   	push   %eax
    2b25:	e8 59 0e 00 00       	call   3983 <write>
  ...
  close(fd);
    ...
    2b34:	53                   	push   %ebx
    2b35:	e8 51 0e 00 00       	call   398b <close>
  printf(1, "dir vs file OK\n");
    ...
    exit();
    2b5e:	e8 00 0e 00 00       	call   3963 <exit>
    ...
    exit();
    2b71:	e8 ed 0d 00 00       	call   3963 <exit>
    ...
    exit();
    2b84:	e8 da 0d 00 00       	call   3963 <exit>
    ...
    exit();
    2b97:	e8 c7 0d 00 00       	call   3963 <exit>
    ...
    exit();
    2baa:	e8 b4 0d 00 00       	call   3963 <exit>
    ...
    exit();
    2bbd:	e8 a1 0d 00 00       	call   3963 <exit>
    ...
    exit();
    2bd0:	e8 8e 0d 00 00       	call   3963 <exit>
    ...
    exit();
    2be3:	e8 7b 0d 00 00       	call   3963 <exit>
    ...
    exit();
    2bf6:	e8 68 0d 00 00       	call   3963 <exit>
    ...
    2c08:	bb 33 00 00 00       	mov    $0x33,%ebx
{
  ...
  printf(1, "empty file name\n");
    ...
    2c40:	e8 8e 0d 00 00       	call   39d3 <chdir>
  ...
  chdir("/");
    ...
    2cd8:	e8 f6 0c 00 00       	call   39d3 <chdir>
  printf(1, "empty file name OK\n");
    ...
    2cfd:	e8 de 0d 00 00       	call   3ae0 <printf>
      exit();
    2d02:	e8 5c 0c 00 00       	call   3963 <exit>
    ...
    2d11:	e8 ca 0d 00 00       	call   3ae0 <printf>
      exit();
    2d16:	e8 48 0c 00 00       	call   3963 <exit>
    ...
    2d28:	31 db                	xor    %ebx,%ebx
{
  ...
  for(n=0; n<1000; n++){
    ...
    pid = fork();
    2d4d:	e8 09 0c 00 00       	call   395b <fork>
    if(pid < 0)
  ...
  for(; n > 0; n--){
    ...
    if(wait() < 0){
    2d60:	e8 06 0c 00 00       	call   396b <wait>
  ...
  if(wait() != -1){
    2d6e:	e8 f8 0b 00 00       	call   396b <wait>
  ...
  printf(1, "fork test OK\n");
    ...
    2d8b:	c3                   	ret    
      exit();
    2d8c:	e8 d2 0b 00 00       	call   3963 <exit>
    ...
    2d9b:	e8 40 0d 00 00       	call   3ae0 <printf>
      exit();
    2da0:	e8 be 0b 00 00       	call   3963 <exit>
    ...
    exit();
    2db3:	e8 ab 0b 00 00       	call   3963 <exit>
    ...
    exit();
    2dc6:	e8 98 0b 00 00       	call   3963 <exit>
    ...
    2dd8:	31 ff                	xor    %edi,%edi
{
  ...
  for(i = 0; i < 5000; i++){
    ...
    2e15:	6a 01                	push   $0x1
    2e17:	e8 cf 0b 00 00       	call   39eb <sbrk>
    if(b != a){
    2e1c:	83 c4 10             	add    $0x10,%esp
    2e1f:	39 f0                	cmp    %esi,%eax
    2e21:	0f 85 77 02 00 00    	jne    309e <sbrktest+0x2ce>
  for(i = 0; i < 5000; i++){
  ...
  pid = fork();
    2e38:	e8 1e 0b 00 00       	call   395b <fork>
    2e3d:	89 c7                	mov    %eax,%edi
  if(pid < 0){
    2e3f:	85 c0                	test   %eax,%eax
    2e41:	0f 88 72 03 00 00    	js     31b9 <sbrktest+0x3e9>
  c = sbrk(1);
  ...
  c = sbrk(1);
    2e4d:	6a 01                	push   $0x1
    2e4f:	e8 97 0b 00 00       	call   39eb <sbrk>
  c = sbrk(1);
    2e54:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e5b:	e8 8b 0b 00 00       	call   39eb <sbrk>
  if(c != a + 1){
    2e60:	83 c4 10             	add    $0x10,%esp
    2e63:	39 c6                	cmp    %eax,%esi
    2e65:	0f 85 37 03 00 00    	jne    31a2 <sbrktest+0x3d2>
  if(pid == 0)
    2e6b:	85 ff                	test   %edi,%edi
    2e6d:	0f 84 2a 03 00 00    	je     319d <sbrktest+0x3cd>
  wait();
    2e73:	e8 f3 0a 00 00       	call   396b <wait>
  a = sbrk(0);
    2e78:	83 ec 0c             	sub    $0xc,%esp
    2e7b:	6a 00                	push   $0x0
    2e7d:	e8 69 0b 00 00       	call   39eb <sbrk>
  ...
  p = sbrk(amt);
    ...
    2e8e:	e8 58 0b 00 00       	call   39eb <sbrk>
  if (p != a) {
    2e93:	83 c4 10             	add    $0x10,%esp
    2e96:	39 c6                	cmp    %eax,%esi
    2e98:	0f 85 e8 02 00 00    	jne    3186 <sbrktest+0x3b6>
  a = sbrk(0);
    2e9e:	83 ec 0c             	sub    $0xc,%esp
    2ea1:	6a 00                	push   $0x0
    2ea3:	e8 43 0b 00 00       	call   39eb <sbrk>
  c = sbrk(-4096);
    2ea8:	c7 04 24 00 f0 ff ff 	movl   $0xfffff000,(%esp)
  a = sbrk(0);
    2eaf:	89 c6                	mov    %eax,%esi
  c = sbrk(-4096);
    2eb1:	e8 35 0b 00 00       	call   39eb <sbrk>
  if(c == (char*)0xffffffff){
    2eb6:	83 c4 10             	add    $0x10,%esp
    2eb9:	83 f8 ff             	cmp    $0xffffffff,%eax
    2ebc:	0f 84 ad 02 00 00    	je     316f <sbrktest+0x39f>
  c = sbrk(0);
    2ec2:	83 ec 0c             	sub    $0xc,%esp
    2ec5:	6a 00                	push   $0x0
    2ec7:	e8 1f 0b 00 00       	call   39eb <sbrk>
  if(c != a - 4096){
    2ecc:	8d 96 00 f0 ff ff    	lea    -0x1000(%esi),%edx
    2ed2:	83 c4 10             	add    $0x10,%esp
    2ed5:	39 d0                	cmp    %edx,%eax
    2ed7:	0f 85 7b 02 00 00    	jne    3158 <sbrktest+0x388>
  a = sbrk(0);
    2edd:	83 ec 0c             	sub    $0xc,%esp
    2ee0:	6a 00                	push   $0x0
    2ee2:	e8 04 0b 00 00       	call   39eb <sbrk>
  c = sbrk(4096);
    2ee7:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
  a = sbrk(0);
    2eee:	89 c6                	mov    %eax,%esi
  c = sbrk(4096);
    2ef0:	e8 f6 0a 00 00       	call   39eb <sbrk>
  if(c != a || sbrk(0) != a + 4096){
    2ef5:	83 c4 10             	add    $0x10,%esp
  c = sbrk(4096);
    2ef8:	89 c7                	mov    %eax,%edi
  if(c != a || sbrk(0) != a + 4096){
    2efa:	39 c6                	cmp    %eax,%esi
    2efc:	0f 85 3f 02 00 00    	jne    3141 <sbrktest+0x371>
    2f02:	83 ec 0c             	sub    $0xc,%esp
    2f05:	6a 00                	push   $0x0
    2f07:	e8 df 0a 00 00       	call   39eb <sbrk>
    2f0c:	8d 96 00 10 00 00    	lea    0x1000(%esi),%edx
    2f12:	83 c4 10             	add    $0x10,%esp
    2f15:	39 c2                	cmp    %eax,%edx
    2f17:	0f 85 24 02 00 00    	jne    3141 <sbrktest+0x371>
  a = sbrk(0);
    2f1d:	83 ec 0c             	sub    $0xc,%esp
    2f20:	6a 00                	push   $0x0
    2f22:	e8 c4 0a 00 00       	call   39eb <sbrk>
  c = sbrk(-(sbrk(0) - oldbrk));
    2f27:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  a = sbrk(0);
    2f2e:	89 c6                	mov    %eax,%esi
  c = sbrk(-(sbrk(0) - oldbrk));
    2f30:	e8 b6 0a 00 00       	call   39eb <sbrk>
    2f35:	89 d9                	mov    %ebx,%ecx
    2f37:	29 c1                	sub    %eax,%ecx
    2f39:	89 0c 24             	mov    %ecx,(%esp)
    2f3c:	e8 aa 0a 00 00       	call   39eb <sbrk>
  if(c != a){
    2f41:	83 c4 10             	add    $0x10,%esp
    2f44:	39 c6                	cmp    %eax,%esi
    2f46:	0f 85 de 01 00 00    	jne    312a <sbrktest+0x35a>
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    2f4c:	be 00 00 00 80       	mov    $0x80000000,%esi
    2f51:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    ppid = getpid();
    2f58:	e8 86 0a 00 00       	call   39e3 <getpid>
    2f5d:	89 c7                	mov    %eax,%edi
    pid = fork();
    2f5f:	e8 f7 09 00 00       	call   395b <fork>
    if(pid < 0){
    2f64:	85 c0                	test   %eax,%eax
    2f66:	0f 88 a6 01 00 00    	js     3112 <sbrktest+0x342>
    if(pid == 0){
    2f6c:	0f 84 7e 01 00 00    	je     30f0 <sbrktest+0x320>
    wait();
    2f72:	e8 f4 09 00 00       	call   396b <wait>
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    2f77:	81 c6 50 c3 00 00    	add    $0xc350,%esi
    2f7d:	81 fe 80 84 1e 80    	cmp    $0x801e8480,%esi
    2f83:	75 d3                	jne    2f58 <sbrktest+0x188>
  if(pipe(fds) != 0){
    2f85:	83 ec 0c             	sub    $0xc,%esp
    2f88:	8d 45 b8             	lea    -0x48(%ebp),%eax
    2f8b:	50                   	push   %eax
    2f8c:	e8 e2 09 00 00       	call   3973 <pipe>
    2f91:	83 c4 10             	add    $0x10,%esp
    2f94:	85 c0                	test   %eax,%eax
    2f96:	0f 85 37 01 00 00    	jne    30d3 <sbrktest+0x303>
    2f9c:	8d 75 c0             	lea    -0x40(%ebp),%esi
    2f9f:	89 f7                	mov    %esi,%edi
    if((pids[i] = fork()) == 0){
    2fa1:	e8 b5 09 00 00       	call   395b <fork>
    2fa6:	89 07                	mov    %eax,(%edi)
    2fa8:	85 c0                	test   %eax,%eax
    2faa:	0f 84 8f 00 00 00    	je     303f <sbrktest+0x26f>
    if(pids[i] != -1)
    2fb0:	83 f8 ff             	cmp    $0xffffffff,%eax
    2fb3:	74 14                	je     2fc9 <sbrktest+0x1f9>
      read(fds[0], &scratch, 1);
    2fb5:	83 ec 04             	sub    $0x4,%esp
    2fb8:	8d 45 b7             	lea    -0x49(%ebp),%eax
    2fbb:	6a 01                	push   $0x1
    2fbd:	50                   	push   %eax
    2fbe:	ff 75 b8             	pushl  -0x48(%ebp)
    2fc1:	e8 b5 09 00 00       	call   397b <read>
    2fc6:	83 c4 10             	add    $0x10,%esp
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    2fc9:	83 c7 04             	add    $0x4,%edi
    2fcc:	8d 45 e8             	lea    -0x18(%ebp),%eax
    2fcf:	39 c7                	cmp    %eax,%edi
    2fd1:	75 ce                	jne    2fa1 <sbrktest+0x1d1>
  c = sbrk(4096);
    2fd3:	83 ec 0c             	sub    $0xc,%esp
    2fd6:	68 00 10 00 00       	push   $0x1000
    2fdb:	e8 0b 0a 00 00       	call   39eb <sbrk>
    2fe0:	83 c4 10             	add    $0x10,%esp
    2fe3:	89 c7                	mov    %eax,%edi
    if(pids[i] == -1)
    2fe5:	8b 06                	mov    (%esi),%eax
    2fe7:	83 f8 ff             	cmp    $0xffffffff,%eax
    2fea:	74 11                	je     2ffd <sbrktest+0x22d>
    kill(pids[i]);
    2fec:	83 ec 0c             	sub    $0xc,%esp
    2fef:	50                   	push   %eax
    2ff0:	e8 9e 09 00 00       	call   3993 <kill>
    wait();
    2ff5:	e8 71 09 00 00       	call   396b <wait>
    2ffa:	83 c4 10             	add    $0x10,%esp
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    2ffd:	83 c6 04             	add    $0x4,%esi
    3000:	8d 45 e8             	lea    -0x18(%ebp),%eax
    3003:	39 f0                	cmp    %esi,%eax
    3005:	75 de                	jne    2fe5 <sbrktest+0x215>
  if(c == (char*)0xffffffff){
    3007:	83 ff ff             	cmp    $0xffffffff,%edi
    300a:	0f 84 ac 00 00 00    	je     30bc <sbrktest+0x2ec>
  if(sbrk(0) > oldbrk)
    3010:	83 ec 0c             	sub    $0xc,%esp
    3013:	6a 00                	push   $0x0
    3015:	e8 d1 09 00 00       	call   39eb <sbrk>
    301a:	83 c4 10             	add    $0x10,%esp
    301d:	39 c3                	cmp    %eax,%ebx
    301f:	72 61                	jb     3082 <sbrktest+0x2b2>
  printf(stdout, "sbrk test OK\n");
    3021:	83 ec 08             	sub    $0x8,%esp
    3024:	68 e0 4c 00 00       	push   $0x4ce0
    3029:	ff 35 b0 5e 00 00    	pushl  0x5eb0
    302f:	e8 ac 0a 00 00       	call   3ae0 <printf>
}
    3034:	83 c4 10             	add    $0x10,%esp
    3037:	8d 65 f4             	lea    -0xc(%ebp),%esp
    303a:	5b                   	pop    %ebx
    303b:	5e                   	pop    %esi
    303c:	5f                   	pop    %edi
    303d:	5d                   	pop    %ebp
    ...
    303f:	83 ec 0c             	sub    $0xc,%esp
    3042:	6a 00                	push   $0x0
    3044:	e8 a2 09 00 00       	call   39eb <sbrk>
    3049:	89 c2                	mov    %eax,%edx
    304b:	b8 00 00 40 06       	mov    $0x6400000,%eax
    3050:	29 d0                	sub    %edx,%eax
    3052:	89 04 24             	mov    %eax,(%esp)
    3055:	e8 91 09 00 00       	call   39eb <sbrk>
      write(fds[1], "x", 1);
    305a:	83 c4 0c             	add    $0xc,%esp
    305d:	6a 01                	push   $0x1
    305f:	68 a1 47 00 00       	push   $0x47a1
    3064:	ff 75 bc             	pushl  -0x44(%ebp)
    3067:	e8 17 09 00 00       	call   3983 <write>
    306c:	83 c4 10             	add    $0x10,%esp
    306f:	90                   	nop
      for(;;) sleep(1000);
    3070:	83 ec 0c             	sub    $0xc,%esp
    3073:	68 e8 03 00 00       	push   $0x3e8
    3078:	e8 76 09 00 00       	call   39f3 <sleep>
    307d:	83 c4 10             	add    $0x10,%esp
    3080:	eb ee                	jmp    3070 <sbrktest+0x2a0>
    sbrk(-(sbrk(0) - oldbrk));
    3082:	83 ec 0c             	sub    $0xc,%esp
    3085:	6a 00                	push   $0x0
    3087:	e8 5f 09 00 00       	call   39eb <sbrk>
    308c:	29 c3                	sub    %eax,%ebx
    308e:	89 1c 24             	mov    %ebx,(%esp)
    3091:	e8 55 09 00 00       	call   39eb <sbrk>
    3096:	83 c4 10             	add    $0x10,%esp
    3099:	e9 83 ff ff ff       	jmp    3021 <sbrktest+0x251>
      printf(stdout, "sbrk test failed %d %x %x\n", i, a, b);
    309e:	83 ec 0c             	sub    $0xc,%esp
    30a1:	50                   	push   %eax
    30a2:	56                   	push   %esi
    30a3:	57                   	push   %edi
    30a4:	68 43 4c 00 00       	push   $0x4c43
    30a9:	ff 35 b0 5e 00 00    	pushl  0x5eb0
    30af:	e8 2c 0a 00 00       	call   3ae0 <printf>
      exit();
    30b4:	83 c4 20             	add    $0x20,%esp
    30b7:	e8 a7 08 00 00       	call   3963 <exit>
    printf(stdout, "failed sbrk leaked memory\n");
    30bc:	50                   	push   %eax
    30bd:	50                   	push   %eax
    30be:	68 c5 4c 00 00       	push   $0x4cc5
    30c3:	ff 35 b0 5e 00 00    	pushl  0x5eb0
    30c9:	e8 12 0a 00 00       	call   3ae0 <printf>
    exit();
    30ce:	e8 90 08 00 00       	call   3963 <exit>
    printf(1, "pipe() failed\n");
    30d3:	52                   	push   %edx
    30d4:	52                   	push   %edx
    30d5:	68 81 41 00 00       	push   $0x4181
    30da:	6a 01                	push   $0x1
    30dc:	e8 ff 09 00 00       	call   3ae0 <printf>
    exit();
    30e1:	e8 7d 08 00 00       	call   3963 <exit>
    30e6:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    30ed:	8d 76 00             	lea    0x0(%esi),%esi
      printf(stdout, "oops could read %x = %x\n", a, *a);
    30f0:	0f be 06             	movsbl (%esi),%eax
    30f3:	50                   	push   %eax
    30f4:	56                   	push   %esi
    30f5:	68 ac 4c 00 00       	push   $0x4cac
    30fa:	ff 35 b0 5e 00 00    	pushl  0x5eb0
    3100:	e8 db 09 00 00       	call   3ae0 <printf>
      kill(ppid);
    3105:	89 3c 24             	mov    %edi,(%esp)
    3108:	e8 86 08 00 00       	call   3993 <kill>
      exit();
    310d:	e8 51 08 00 00       	call   3963 <exit>
      printf(stdout, "fork failed\n");
    3112:	83 ec 08             	sub    $0x8,%esp
    3115:	68 89 4d 00 00       	push   $0x4d89
    311a:	ff 35 b0 5e 00 00    	pushl  0x5eb0
    3120:	e8 bb 09 00 00       	call   3ae0 <printf>
      exit();
    3125:	e8 39 08 00 00       	call   3963 <exit>
    printf(stdout, "sbrk downsize failed, a %x c %x\n", a, c);
    312a:	50                   	push   %eax
    312b:	56                   	push   %esi
    312c:	68 5c 54 00 00       	push   $0x545c
    3131:	ff 35 b0 5e 00 00    	pushl  0x5eb0
    3137:	e8 a4 09 00 00       	call   3ae0 <printf>
    exit();
    313c:	e8 22 08 00 00       	call   3963 <exit>
    printf(stdout, "sbrk re-allocation failed, a %x c %x\n", a, c);
    3141:	57                   	push   %edi
    3142:	56                   	push   %esi
    3143:	68 34 54 00 00       	push   $0x5434
    3148:	ff 35 b0 5e 00 00    	pushl  0x5eb0
    314e:	e8 8d 09 00 00       	call   3ae0 <printf>
    exit();
    3153:	e8 0b 08 00 00       	call   3963 <exit>
    printf(stdout, "sbrk deallocation produced wrong address, a %x c %x\n", a, c);
    3158:	50                   	push   %eax
    3159:	56                   	push   %esi
    315a:	68 fc 53 00 00       	push   $0x53fc
    315f:	ff 35 b0 5e 00 00    	pushl  0x5eb0
    3165:	e8 76 09 00 00       	call   3ae0 <printf>
    exit();
    316a:	e8 f4 07 00 00       	call   3963 <exit>
    printf(stdout, "sbrk could not deallocate\n");
    316f:	51                   	push   %ecx
    3170:	51                   	push   %ecx
    3171:	68 91 4c 00 00       	push   $0x4c91
    3176:	ff 35 b0 5e 00 00    	pushl  0x5eb0
    317c:	e8 5f 09 00 00       	call   3ae0 <printf>
    exit();
    3181:	e8 dd 07 00 00       	call   3963 <exit>
    printf(stdout, "sbrk test failed to grow big address space; enough phys mem?\n");
    3186:	53                   	push   %ebx
    3187:	53                   	push   %ebx
    3188:	68 bc 53 00 00       	push   $0x53bc
    318d:	ff 35 b0 5e 00 00    	pushl  0x5eb0
    3193:	e8 48 09 00 00       	call   3ae0 <printf>
    exit();
    3198:	e8 c6 07 00 00       	call   3963 <exit>
    exit();
    319d:	e8 c1 07 00 00       	call   3963 <exit>
    printf(stdout, "sbrk test failed post-fork\n");
    31a2:	56                   	push   %esi
    31a3:	56                   	push   %esi
    31a4:	68 75 4c 00 00       	push   $0x4c75
    31a9:	ff 35 b0 5e 00 00    	pushl  0x5eb0
    31af:	e8 2c 09 00 00       	call   3ae0 <printf>
    exit();
    31b4:	e8 aa 07 00 00       	call   3963 <exit>
    printf(stdout, "sbrk test fork failed\n");
    31b9:	57                   	push   %edi
    31ba:	57                   	push   %edi
    31bb:	68 5e 4c 00 00       	push   $0x4c5e
    31c0:	ff 35 b0 5e 00 00    	pushl  0x5eb0
    31c6:	e8 15 09 00 00       	call   3ae0 <printf>
    exit();
    31cb:	e8 93 07 00 00       	call   3963 <exit>
    ...
    31e8:	31 f6                	xor    %esi,%esi
{
  ...
  printf(stdout, "validate test\n");
    ...
    31ee:	68 ee 4c 00 00       	push   $0x4cee
    31f3:	ff 35 b0 5e 00 00    	pushl  0x5eb0
    31f9:	e8 e2 08 00 00       	call   3ae0 <printf>
    ...
    kill(pid);
    3229:	89 1c 24             	mov    %ebx,(%esp)
    322c:	e8 62 07 00 00       	call   3993 <kill>
    wait();
    3231:	e8 35 07 00 00       	call   396b <wait>
    if(link("nosuchfile", (char*)p) != -1){
    3236:	58                   	pop    %eax
    3237:	5a                   	pop    %edx
    3238:	56                   	push   %esi
    3239:	68 fd 4c 00 00       	push   $0x4cfd
    323e:	e8 80 07 00 00       	call   39c3 <link>
    3243:	83 c4 10             	add    $0x10,%esp
    3246:	83 f8 ff             	cmp    $0xffffffff,%eax
    3249:	75 30                	jne    327b <validatetest+0x9b>
  for(p = 0; p <= (uint)hi; p += 4096){
    324b:	81 c6 00 10 00 00    	add    $0x1000,%esi
    3251:	81 fe 00 40 11 00    	cmp    $0x114000,%esi
    3257:	75 af                	jne    3208 <validatetest+0x28>
  printf(stdout, "validate ok\n");
    3259:	83 ec 08             	sub    $0x8,%esp
    325c:	68 21 4d 00 00       	push   $0x4d21
    3261:	ff 35 b0 5e 00 00    	pushl  0x5eb0
    3267:	e8 74 08 00 00       	call   3ae0 <printf>
}
    ...
    3275:	c3                   	ret    
      exit();
    3276:	e8 e8 06 00 00       	call   3963 <exit>
      printf(stdout, "link should not succeed\n");
    327b:	83 ec 08             	sub    $0x8,%esp
    327e:	68 08 4d 00 00       	push   $0x4d08
    3283:	ff 35 b0 5e 00 00    	pushl  0x5eb0
    3289:	e8 52 08 00 00       	call   3ae0 <printf>
      exit();
    328e:	e8 d0 06 00 00       	call   3963 <exit>
...
000032a0 <bsstest>:
{
  ...
  printf(stdout, "bss test\n");
    32aa:	68 2e 4d 00 00       	push   $0x4d2e
    32af:	ff 35 b0 5e 00 00    	pushl  0x5eb0
    32b5:	e8 26 08 00 00       	call   3ae0 <printf>
    32ba:	83 c4 10             	add    $0x10,%esp
  for(i = 0; i < sizeof(uninit); i++){
    32bd:	31 c0                	xor    %eax,%eax
    32bf:	90                   	nop
    if(uninit[i] != '\0'){
    32c0:	80 b8 80 5f 00 00 00 	cmpb   $0x0,0x5f80(%eax)
  ...
  printf(stdout, "bss test ok\n");
    ...
    32d6:	68 49 4d 00 00       	push   $0x4d49
    32db:	ff 35 b0 5e 00 00    	pushl  0x5eb0
    32e1:	e8 fa 07 00 00       	call   3ae0 <printf>
}
    ...
    32ee:	68 38 4d 00 00       	push   $0x4d38
    32f3:	ff 35 b0 5e 00 00    	pushl  0x5eb0
    32f9:	e8 e2 07 00 00       	call   3ae0 <printf>
      exit();
...
00003310 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    331a:	68 56 4d 00 00       	push   $0x4d56
  ...
  fd = open("bigarg-ok", 0);
    ...
    333e:	6a 00                	push   $0x0
    3340:	68 56 4d 00 00       	push   $0x4d56
  ...
  unlink("bigarg-ok");
    335e:	c7 04 24 56 4d 00 00 	movl   $0x4d56,(%esp)
    ...
    3370:	c7 04 85 e0 5e 00 00 	movl   $0x5480,0x5ee0(,%eax,4)
    3377:	80 54 00 00 
    ...
    3383:	51                   	push   %ecx
    3384:	51                   	push   %ecx
    3385:	68 60 4d 00 00       	push   $0x4d60
    338a:	ff 35 b0 5e 00 00    	pushl  0x5eb0
    args[MAXARG-1] = 0;
    3390:	c7 05 5c 5f 00 00 00 	movl   $0x0,0x5f5c
    3397:	00 00 00 
    printf(stdout, "bigarg test\n");
    339a:	e8 41 07 00 00       	call   3ae0 <printf>
    exec("echo", args);
    339f:	58                   	pop    %eax
    33a0:	5a                   	pop    %edx
    33a1:	68 e0 5e 00 00       	push   $0x5ee0
    33a6:	68 2d 3f 00 00       	push   $0x3f2d
    33ab:	e8 eb 05 00 00       	call   399b <exec>
    printf(stdout, "bigarg test ok\n");
    33b0:	59                   	pop    %ecx
    33b1:	58                   	pop    %eax
    33b2:	68 6d 4d 00 00       	push   $0x4d6d
    33b7:	ff 35 b0 5e 00 00    	pushl  0x5eb0
    33bd:	e8 1e 07 00 00       	call   3ae0 <printf>
    fd = open("bigarg-ok", O_CREATE);
    33c2:	58                   	pop    %eax
    33c3:	5a                   	pop    %edx
    33c4:	68 00 02 00 00       	push   $0x200
    33c9:	68 56 4d 00 00       	push   $0x4d56
    ...
    33e0:	50                   	push   %eax
    33e1:	50                   	push   %eax
    33e2:	68 96 4d 00 00       	push   $0x4d96
    33e7:	ff 35 b0 5e 00 00    	pushl  0x5eb0
    ...
    33f7:	52                   	push   %edx
    33f8:	52                   	push   %edx
    33f9:	68 7d 4d 00 00       	push   $0x4d7d
    33fe:	ff 35 b0 5e 00 00    	pushl  0x5eb0
    3404:	e8 d7 06 00 00       	call   3ae0 <printf>
    exit();
    ...
    3419:	31 f6                	xor    %esi,%esi
{
  ...
  printf(1, "fsfull test\n");
    341f:	68 ab 4d 00 00       	push   $0x4dab
    3424:	6a 01                	push   $0x1
    3426:	e8 b5 06 00 00       	call   3ae0 <printf>
    ...
    34a3:	50                   	push   %eax
    34a4:	68 b8 4d 00 00       	push   $0x4db8
    34a9:	6a 01                	push   $0x1
    34ab:	e8 30 06 00 00       	call   3ae0 <printf>
    ...
    34da:	68 a0 86 00 00       	push   $0x86a0
    34df:	57                   	push   %edi
    ...
    34f2:	53                   	push   %ebx
    34f3:	68 d4 4d 00 00       	push   $0x4dd4
    34f8:	6a 01                	push   $0x1
    34fa:	e8 e1 05 00 00       	call   3ae0 <printf>
    close(fd);
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    351c:	50                   	push   %eax
    351d:	68 c4 4d 00 00       	push   $0x4dc4
    3522:	6a 01                	push   $0x1
    3524:	e8 b7 05 00 00       	call   3ae0 <printf>
      break;
  ...
  printf(1, "fsfull test finished\n");
    ...
    35ce:	68 e4 4d 00 00       	push   $0x4de4
    35d3:	6a 01                	push   $0x1
    35d5:	e8 06 05 00 00       	call   3ae0 <printf>
}
...
000035f0 <uio>:
{
  ...
  printf(1, "uio test\n");
    35fa:	68 fa 4d 00 00       	push   $0x4dfa
    35ff:	6a 01                	push   $0x1
    3601:	e8 da 04 00 00       	call   3ae0 <printf>
  pid = fork();
  ...
  printf(1, "uio test done\n");
    ...
    361c:	68 04 4e 00 00       	push   $0x4e04
    3621:	6a 01                	push   $0x1
    3623:	e8 b8 04 00 00       	call   3ae0 <printf>
}
    ...
    363e:	52                   	push   %edx
    363f:	52                   	push   %edx
    3640:	68 60 55 00 00       	push   $0x5560
    3645:	6a 01                	push   $0x1
    3647:	e8 94 04 00 00       	call   3ae0 <printf>
    exit();
    364c:	e8 12 03 00 00       	call   3963 <exit>
    printf (1, "fork failed\n");
    3651:	50                   	push   %eax
    3652:	50                   	push   %eax
    3653:	68 89 4d 00 00       	push   $0x4d89
    3658:	6a 01                	push   $0x1
    365a:	e8 81 04 00 00       	call   3ae0 <printf>
    exit();
...
00003670 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    367b:	6a 00                	push   $0x0
    367d:	68 13 4e 00 00       	push   $0x4e13
  ...
  printf(1, "arg test passed\n");
    36b1:	58                   	pop    %eax
    36b2:	5a                   	pop    %edx
    36b3:	68 25 4e 00 00       	push   $0x4e25
    36b8:	6a 01                	push   $0x1
    36ba:	e8 21 04 00 00       	call   3ae0 <printf>
}
    ...
    36c7:	51                   	push   %ecx
    36c8:	51                   	push   %ecx
    36c9:	68 18 4e 00 00       	push   $0x4e18
    36ce:	6a 02                	push   $0x2
    36d0:	e8 0b 04 00 00       	call   3ae0 <printf>
    exit();
...
000036e0 <rand>:
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    36e4:	69 05 ac 5e 00 00 0d 	imul   $0x19660d,0x5eac,%eax
    36eb:	66 19 00 
    36ee:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    36f3:	a3 ac 5e 00 00       	mov    %eax,0x5eac
}
    36f8:	c3                   	ret    
...
00003a1b <sem_init>:
    3a1b:	b8 19 00 00 00       	mov    $0x19,%eax
    3a20:	cd 40                	int    $0x40
    3a22:	c3                   	ret    
    ...
    3a3c:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    ...
    3a69:	0f b6 92 b8 55 00 00 	movzbl 0x55b8(%edx),%edx
  ...
  write(fd, &c, 1);
    ...
    3aae:	56                   	push   %esi
    3aaf:	57                   	push   %edi
    3ab0:	e8 ce fe ff ff       	call   3983 <write>
  while(--i >= 0)
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    3b29:	e8 55 fe ff ff       	call   3983 <write>
  ...
  write(fd, &c, 1);
    ...
    3b89:	e8 f5 fd ff ff       	call   3983 <write>
        putc(fd, c);
      } else {
  ...
  write(fd, &c, 1);
    ...
    3b9d:	e8 e1 fd ff ff       	call   3983 <write>
  for(i = 0; fmt[i]; i++){
  ...
  write(fd, &c, 1);
    3c14:	e8 6a fd ff ff       	call   3983 <write>
        ap++;
  ...
  write(fd, &c, 1);
    ...
    3c64:	eb 1a                	jmp    3c80 <printf+0x1a0>
          s = "(null)";
    3c66:	bb ae 55 00 00       	mov    $0x55ae,%ebx
        while(*s != 0){
  ...
  write(fd, &c, 1);
    ...
    3c8b:	57                   	push   %edi
    3c8c:	53                   	push   %ebx
    3c8d:	e8 f1 fc ff ff       	call   3983 <write>
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3cb5:	a1 60 5f 00 00       	mov    0x5f60,%eax
{
    ...
    3cd6:	73 10                	jae    3ce8 <free+0x38>
{
  ...
  freep = p;
    ...
    3d01:	5b                   	pop    %ebx
  freep = p;
    3d02:	a3 60 5f 00 00       	mov    %eax,0x5f60
}
    3d07:	5e                   	pop    %esi
    3d08:	5f                   	pop    %edi
    3d09:	5d                   	pop    %ebp
  ...
  freep = p;
    3d2a:	a3 60 5f 00 00       	mov    %eax,0x5f60
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    3d50:	8b 3d 60 5f 00 00    	mov    0x5f60,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    3d99:	8b 3d 60 5f 00 00    	mov    0x5f60,%edi
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    3dab:	e8 3b fc ff ff       	call   39eb <sbrk>
  if(p == (char*)-1)
  ...
  return freep;
    3dc7:	a1 60 5f 00 00       	mov    0x5f60,%eax
    ...
    3df4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
    3df7:	a3 60 5f 00 00       	mov    %eax,0x5f60
}
    ...
    base.s.ptr = freep = prevp = &base;
    3e10:	c7 05 60 5f 00 00 64 	movl   $0x5f64,0x5f60
    3e17:	5f 00 00 
    base.s.size = 0;
    3e1a:	bf 64 5f 00 00       	mov    $0x5f64,%edi
    base.s.ptr = freep = prevp = &base;
    3e1f:	c7 05 64 5f 00 00 64 	movl   $0x5f64,0x5f64
    3e26:	5f 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3e29:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
    3e2b:	c7 05 68 5f 00 00 00 	movl   $0x0,0x5f68
    3e32:	00 00 00 
    if(p->s.size >= nunits){
