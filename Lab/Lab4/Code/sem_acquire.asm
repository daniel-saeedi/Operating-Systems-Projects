...
_sem_acquire:     file format elf32-i386
  ...
  15:	83 39 01             	cmpl   $0x1,(%ecx)
{
  ...
  23:	e8 18 02 00 00       	call   240 <atoi>
    else {
  ...
  2b:	e8 2b 03 00 00       	call   35b <sem_acquire>

    exit();
  30:	e8 7e 02 00 00       	call   2b3 <exit>
        printf(1, "Invalid inputs for sem_acquire\n");
  35:	50                   	push   %eax
  36:	50                   	push   %eax
  37:	68 98 07 00 00       	push   $0x798
  3c:	6a 01                	push   $0x1
  3e:	e8 ed 03 00 00       	call   430 <printf>
        exit();
...
printf(int fd, const char *fmt, ...)
{
 ...
 5b4:	eb 1a                	jmp    5d0 <printf+0x1a0>
          s = "(null)";
 5b6:	bb b8 07 00 00       	mov    $0x7b8,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 605:	a1 68 0a 00 00       	mov    0xa68,%eax
{
...
malloc(uint nbytes)
{
 ...
 69d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6a0:	8b 3d 68 0a 00 00    	mov    0xa68,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 712:	e8 e9 fe ff ff       	call   600 <free>
  return freep;
 717:	a1 68 0a 00 00       	mov    0xa68,%eax
 ...
 744:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 747:	a3 68 0a 00 00       	mov    %eax,0xa68
}
