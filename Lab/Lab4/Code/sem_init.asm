...
_sem_init:     file format elf32-i386
  ...
  17:	83 39 02             	cmpl   $0x2,(%ecx)
{
  1a:	8b 71 04             	mov    0x4(%ecx),%esi
    if(argc > 2) {
  1d:	7e 24                	jle    43 <main+0x43>
        arg1 = atoi(argv[1]);
  1f:	83 ec 0c             	sub    $0xc,%esp
  22:	ff 76 04             	pushl  0x4(%esi)
  25:	e8 26 02 00 00       	call   250 <atoi>
        arg2 = atoi(argv[2]);
  2a:	5a                   	pop    %edx
  2b:	ff 76 08             	pushl  0x8(%esi)
        arg1 = atoi(argv[1]);
  ...
  37:	50                   	push   %eax
  38:	53                   	push   %ebx
  39:	e8 3d 03 00 00       	call   37b <sem_init>

    exit();
  3e:	e8 80 02 00 00       	call   2c3 <exit>
        printf(1, "Invalid inputs for sem_init\n");
  43:	50                   	push   %eax
  44:	50                   	push   %eax
  45:	68 a8 07 00 00       	push   $0x7a8
  4a:	6a 01                	push   $0x1
  4c:	e8 ef 03 00 00       	call   440 <printf>
        exit();
  51:	e8 6d 02 00 00       	call   2c3 <exit>
  56:	66 90                	xchg   %ax,%ax
  58:	66 90                	xchg   %ax,%ax
  5a:	66 90                	xchg   %ax,%ax
  5c:	66 90                	xchg   %ax,%ax
...
printf(int fd, const char *fmt, ...)
{
 ...
 5c4:	eb 1a                	jmp    5e0 <printf+0x1a0>
          s = "(null)";
 5c6:	bb c5 07 00 00       	mov    $0x7c5,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 615:	a1 7c 0a 00 00       	mov    0xa7c,%eax
{
 ...
 636:	73 10                	jae    648 <free+0x38>
{
 ...
 661:	5b                   	pop    %ebx
  freep = p;
 662:	a3 7c 0a 00 00       	mov    %eax,0xa7c
}
 667:	5e                   	pop    %esi
 668:	5f                   	pop    %edi
 669:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 6ad:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6b0:	8b 3d 7c 0a 00 00    	mov    0xa7c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
