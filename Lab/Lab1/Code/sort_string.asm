...
main(int argc, char *argv[])
{
  ...
  17:	8b 78 04             	mov    0x4(%eax),%edi
  int stringLength = strlen(curr_string);
  1a:	57                   	push   %edi
  1b:	8d 5f 01             	lea    0x1(%edi),%ebx
  char* curr_string = argv[1];
  1e:	89 7d dc             	mov    %edi,-0x24(%ebp)
  int stringLength = strlen(curr_string);
  21:	e8 3a 01 00 00       	call   160 <strlen>
  char temp;
  ...
  for (int i = 0; i < stringLength - 1; i++) {
  2b:	8d 48 ff             	lea    -0x1(%eax),%ecx
  int stringLength = strlen(curr_string);
  2e:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  for (int i = 0; i < stringLength - 1; i++) {
  31:	89 f8                	mov    %edi,%eax
  33:	01 f0                	add    %esi,%eax
  35:	89 4d e0             	mov    %ecx,-0x20(%ebp)
  38:	31 ff                	xor    %edi,%edi
  3a:	89 c6                	mov    %eax,%esi
  3c:	85 c9                	test   %ecx,%ecx
  3e:	7e 2f                	jle    6f <main+0x6f>
  ...
  72:	68 a8 07 00 00       	push   $0x7a8
  77:	e8 f7 02 00 00       	call   373 <unlink>
  fd = open("sort_string.txt", O_CREATE | O_RDWR);
  7c:	5a                   	pop    %edx
  7d:	59                   	pop    %ecx
  7e:	68 02 02 00 00       	push   $0x202
  83:	68 a8 07 00 00       	push   $0x7a8
  88:	e8 d6 02 00 00       	call   363 <open>
  if(fd < 0){
  ...
  9c:	ff 75 dc             	push   -0x24(%ebp)
  9f:	53                   	push   %ebx
  a0:	e8 9e 02 00 00       	call   343 <write>
  close(fd);
 ...
 489:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4f9:	ff 24 85 e8 07 00 00 	jmp    *0x7e8(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 607:	90                   	nop
          s = "(null)";
 608:	ba de 07 00 00       	mov    $0x7de,%edx
        while(*s != 0){
